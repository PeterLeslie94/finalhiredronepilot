...
import { Map, Ruler, Mountain, Building2, Layers, BarChart3, Clock, PoundSterling } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Drone Survey Services UK | UAV Surveys & Mapping | Hire Drone Pilot',
  description: 'Professional drone survey services across the UK. Topographic, site, volumetric and construction surveys with sub-centimetre accuracy. CAA certified pilots. Fast turnaround.',
  keywords: 'drone survey, drone surveys uk, uav survey, drone topographic survey, drone site survey, aerial survey services',
};
  ...
  return (
    <>
      <ServiceSchema
        ...
        description="Professional drone survey services across the UK. Topographic, site, volumetric and construction surveys with sub-centimetre accuracy. CAA certified pilots. Fast turnaround."
        url="https://hiredronepilot.uk/services/drone-surveys"
      />
      <BreadcrumbSchema items={[
        { name: "Home", url: "https://hiredronepilot.uk" },
        { name: "Services", url: "https://hiredronepilot.uk/services" },
        { name: "Drone Survey Services", url: "https://hiredronepilot.uk/services/drone-surveys" }
      ]} />
      ...
      <section className="relative min-h-[800px] md:min-h-[600px] flex items-start bg-teal -mt-[120px] pt-[120px] overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Professional drone conducting aerial survey over UK landscape"
            fill
        ...
        <div className="container pt-8 pb-52 lg:pb-40 lg:pt-12 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-white/80 text-lg md:text-xl mb-8">
              Comprehensive aerial surveys delivering topographic data, volumetric calculations, and site mapping with sub-centimetre accuracy. Faster, safer, and more cost-effective than traditional ground-based methods.
            </p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div>
                <h2 id="what-are-drone-surveys" className="text-2xl md:text-3xl font-bold text-teal mb-4 scroll-mt-32">
                  What Are <span className="text-gold">Drone Surveys</span>?
                </h2>
                <p className="text-text-secondary text-lg leading-relaxed mb-4">
                  A drone survey uses unmanned aerial vehicles equipped with high-resolution cameras and sensors to capture detailed spatial data from above. The imagery is processed using photogrammetry software to produce accurate maps, 3D models, elevation data, and volumetric measurements that would traditionally require extensive ground crews and costly equipment.
                </p>
                <p className="text-text-secondary text-lg leading-relaxed">
                  At Hire Drone Pilot, we deliver professional drone survey services across the UK, from small residential plots to large-scale construction and infrastructure projects. Our CAA-certified pilots use enterprise-grade equipment to achieve survey-grade accuracy, providing outputs that integrate seamlessly with CAD, GIS, and BIM platforms.
                </p>
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2.5">
                        {[
                          'Orthomosaic maps & DSM/DTM',
                          'Volumetric calculations',
                          'Contour mapping & cross-sections',
                    ...
                    <div>
                      ...
                      <ul className="space-y-2.5">
                        {[
                          ...
                          'Sub-centimetre accuracy with GCPs',
                      ...
                      <p className="text-white/70 text-sm mt-4 flex items-start gap-2">
                        ...
                        <span>Trusted by engineers, architects, land managers & developers across the UK.</span>
                      </p>
                    </div>
                  </div>
              ...
              <div>
                <h2 id="drone-survey-cost" className="text-2xl md:text-3xl font-bold text-teal mb-4 scroll-mt-32">
                  How Much Do <span className="text-gold">Drone Surveys</span> Cost?
                </h2>
                <p className="text-text-secondary text-lg leading-relaxed mb-6">
                  Drone survey pricing depends on site area, required accuracy, and deliverable types. Here is a guide to help with budgeting:
                </p>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="bg-teal">
                        ...
                        <th className="text-left text-white font-semibold py-3 px-4 hidden md:table-cell">Typical Sites</th>
                        <th className="text-left text-white font-semibold py-3 px-4 hidden lg:table-cell">Deliverables</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="bg-white">
                        <td className="py-3 px-4 text-text-primary font-medium">Small Site<span className="block text-sm text-text-secondary font-normal">Up to 1 hectare</span></td>
                        <td className="py-3 px-4 text-gold font-bold">£400+</td>
                        <td className="py-3 px-4 text-text-secondary text-sm hidden md:table-cell">Residential plots, car parks, small fields</td>
                        <td className="py-3 px-4 text-text-secondary text-sm hidden lg:table-cell">Orthomosaic, basic DTM</td>
                      </tr>
                      <tr className="bg-background-alt">
                        ...
                        <td className="py-3 px-4 text-text-secondary text-sm hidden md:table-cell">Construction sites, farmland, estates</td>
                        <td className="py-3 px-4 text-text-secondary text-sm hidden lg:table-cell">Full survey package with contours</td>
                      </tr>
                      <tr className="bg-white">
                        <td className="py-3 px-4 text-text-primary font-medium">Large Site<span className="block text-sm text-text-secondary font-normal">5-20 hectares</span></td>
                        <td className="py-3 px-4 text-gold font-bold">£1,200+</td>
                        <td className="py-3 px-4 text-text-secondary text-sm hidden md:table-cell">Quarries, large developments, corridors</td>
                        <td className="py-3 px-4 text-text-secondary text-sm hidden lg:table-cell">Comprehensive survey & 3D model</td>
                      </tr>
                      <tr className="bg-background-alt">
                        <td className="py-3 px-4 text-text-primary font-medium">Very Large/Complex<span className="block text-sm text-text-secondary font-normal">20+ hectares</span></td>
                        <td className="py-3 px-4 text-gold font-bold">POA</td>
                        <td className="py-3 px-4 text-text-secondary text-sm hidden md:table-cell">Infrastructure, mining, large estates</td>
                ...
                <p className="text-text-secondary text-sm mb-6 italic">
                  *Guide prices include standard deliverables. Final quotation depends on site complexity, location, and specific requirements.
                </p>

                {/* What affects your quote */}
                <h3 className="font-bold text-teal mb-3">Factors Influencing Your Quote</h3>
                <ul className="grid grid-cols-2 gap-2 mb-6">
                  {['Site area & terrain complexity', 'Required accuracy level', 'Number of ground control points', 'Deliverable format & outputs'].map((factor, index) => (
                ...
                <p className="text-text-secondary leading-relaxed mb-6">
                  Compared to traditional land surveys, a drone survey typically saves <span className="text-gold font-semibold">40-60%</span> on costs while delivering results significantly faster. Send us your site details for a tailored quotation within 24 hours.
                </p>
                {/* CTA Banner */}
                <div className="bg-teal rounded-xl p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="text-center sm:text-left">
                    <p className="text-white font-semibold">Ready to receive a quote for your drone survey?</p>
              ...
              <div>
                <h2 id="drone-vs-traditional" className="text-2xl md:text-3xl font-bold text-teal mb-4 scroll-mt-32">
                  How Do <span className="text-gold">Drone Surveys</span> Compare to Traditional Methods?
                </h2>
                <p className="text-text-secondary text-lg leading-relaxed mb-4">
                  Traditional land surveys rely on ground-based teams using total stations, GPS rovers, and manual measurements. While accurate, these methods are labour-intensive, time-consuming, and become impractical on large or difficult-to-access sites. A drone survey captures equivalent data in a fraction of the time. We can map 20+ hectares in a single flight session, collecting thousands of data points per second, with complete site coverage rather than spot measurements.
                </p>
                {/* Comparison Cards */}
                <div className="mt-8">
                    ...
                    <div className="relative bg-teal rounded-2xl p-6 overflow-hidden group hover:shadow-xl transition-shadow duration-300">
                      <div className="relative z-10">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <div>
                            <h4 className="text-white font-bold text-lg">Drone Survey</h4>
                            <p className="text-gold text-sm font-medium">Fast, comprehensive & accurate</p>
                          </div>
                        </div>
                        <div className="space-y-3">
                          {[
                            { Icon: Clock, text: 'Complete site in hours' },
                            { Icon: Map, text: 'Full area coverage guaranteed' },
                            { Icon: PoundSterling, text: '40-60% cost savings' },
                            { Icon: Layers, text: '3D models & orthomosaics' },
                          ].map((item, i) => (
                      ...
                      <div className="relative z-10">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <div>
                            ...
                            <p className="text-text-secondary text-sm font-medium">Ground crews & total stations</p>
                          </div>
                        </div>
                        <div className="space-y-3">
                          {[
                            { text: 'Days or weeks on large sites', negative: true },
                            { text: 'Spot measurements only', negative: true },
                            { text: 'Higher labour costs', negative: true },
                            { text: 'Limited in hazardous terrain', negative: true },
                          ].map((item, i) => (
                  ...
                  <div className="mt-6 text-center">
                    <p className="text-text-secondary text-sm mb-2">Not sure which survey method suits your project?</p>
              ...
              <div>
                <h2 id="drone-survey-accuracy" className="text-2xl md:text-3xl font-bold text-teal mb-4 scroll-mt-32">
              ...
              <div>
                <h2 id="types-of-drone-surveys" className="text-2xl md:text-3xl font-bold text-teal mb-4 scroll-mt-32">
                  Types of <span className="text-gold">Drone Surveys</span> We Provide
                </h2>
                <p className="text-text-secondary text-lg leading-relaxed mb-6">We offer a comprehensive range of drone survey services. Here are the primary survey types our clients commission:</p>
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-background-alt rounded-xl p-6">
                    ...
                    <p className="text-text-secondary text-sm">Regular progress surveys to track build stages, compare against design models, and produce as-built documentation for stakeholders.</p>
                  </div>
                  <div className="bg-background-alt rounded-xl p-6">
                  ...
                  <div className="bg-background-alt rounded-xl p-6">
                    ...
                    <h3 className="font-bold text-teal mb-2">3D Modelling</h3>
                    <p className="text-text-secondary text-sm">Photorealistic 3D models of sites, structures, and landscapes for visualisation, planning, and stakeholder presentations.</p>
                  </div>
                </div>

                {/* CTA after applications */}
                <div className="mt-8 text-center">
                  <p className="text-text-secondary mb-4">Need a survey for your project?</p>
              ...
              <div>
                <h2 id="drone-survey-deliverables" className="text-2xl md:text-3xl font-bold text-teal mb-4 scroll-mt-32">
                  What Deliverables Do You Receive From a <span className="text-gold">Drone Survey</span>?
                </h2>
                <p className="text-text-secondary text-lg leading-relaxed mb-6">We tailor outputs to match your requirements, but our standard drone survey packages include:</p>
                <ul className="space-y-4">
                  <li className="flex items-start gap-4 bg-background-alt rounded-xl p-4">
                    ...
                    <div>
                      <h4 className="font-bold text-teal">Orthomosaic Maps</h4>
                      <p className="text-text-secondary text-sm">Georeferenced aerial imagery stitched into a single, scaled map. Suitable for measurement, area calculations, and site documentation.</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4 bg-background-alt rounded-xl p-4">
                    <div className="w-10 h-10 bg-gold/20 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">DSM and DTM outputs with elevation data, enabling contour generation, cross-section profiles, and earthworks volume calculations.</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4 bg-background-alt rounded-xl p-4">
                    <div className="w-10 h-10 bg-gold/20 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      <h4 className="font-bold text-teal">3D Point Clouds & Models</h4>
                      <p className="text-text-secondary text-sm">Dense point cloud data and textured 3D mesh models for visualisation, BIM integration, and detailed analysis.</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4 bg-background-alt rounded-xl p-4">
                    <div className="w-10 h-10 bg-gold/20 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      <h4 className="font-bold text-teal">Survey Reports & CAD Drawings</h4>
                      <p className="text-text-secondary text-sm">Professional survey reports with annotated plans exported in DWG, DXF, or GeoTIFF format for direct use in your design workflow.</p>
                    </div>
                  </li>
                </ul>
              ...
              <div>
                <h2 id="survey-timeline" className="text-2xl md:text-3xl font-bold text-teal mb-4 scroll-mt-32">
                  How Long Does a <span className="text-gold">Drone Survey</span> Take?
                </h2>
                <p className="text-text-secondary text-lg leading-relaxed mb-6">
                  On-site data capture is remarkably swift. A 1-hectare site typically requires 30-45 minutes of flight time. Medium sites of 5 hectares can be completed within half a day, including GCP establishment. Standard orthomosaic and terrain outputs are typically ready within 3-5 working days. Complex projects requiring volumetric analysis or 3D modelling may take 5-7 days.
                </p>
                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      <tr className="bg-white">
                        ...
                        <td className="py-3 px-4 text-text-secondary text-sm hidden md:table-cell">Flight planning, airspace checks, GCP coordination</td>
                      </tr>
                      <tr className="bg-background-alt">
                        <td className="py-3 px-4 text-text-primary font-medium">On-Site Data Capture</td>
                        <td className="py-3 px-4 text-gold font-bold">30 mins - 1 day</td>
                        <td className="py-3 px-4 text-text-secondary text-sm hidden md:table-cell">GCP setup, drone flights, quality checks</td>
                      </tr>
                      <tr className="bg-white">
                        <td className="py-3 px-4 text-text-primary font-medium">Data Processing</td>
                        <td className="py-3 px-4 text-gold font-bold">1-3 days</td>
                        <td className="py-3 px-4 text-text-secondary text-sm hidden md:table-cell">Photogrammetry, georeferencing, model generation</td>
                      </tr>
                      <tr className="bg-background-alt">
                        <td className="py-3 px-4 text-text-primary font-medium">Deliverable Production</td>
                        <td className="py-3 px-4 text-gold font-bold">1-3 days</td>
                        <td className="py-3 px-4 text-text-secondary text-sm hidden md:table-cell">Map production, CAD export, report writing</td>
                      </tr>
                      <tr className="bg-teal/10">
                        <td className="py-3 px-4 text-teal font-bold">Total (Standard)</td>
                        <td className="py-3 px-4 text-teal font-bold">3-7 working days</td>
              ...
              {/* How to Choose a Drone Survey Provider */}
              <div>
                <h2 id="choose-provider" className="text-2xl md:text-3xl font-bold text-teal mb-4 scroll-mt-32">
                  How to Choose a <span className="text-gold">Drone Survey</span> Provider
                </h2>
                <p className="text-text-secondary text-lg leading-relaxed mb-4">
                  Not all drone survey providers deliver the same standard. We recommend examining these criteria:
                </p>
                <ul className="space-y-3 mb-6">
                  {[
                    { bold: 'CAA certification', text: ' – Valid GVC or legacy PfCO permissions for commercial operations' },
                    { bold: 'Survey-grade equipment', text: ' – RTK-enabled drones and professional photogrammetry software' },
                    { bold: 'Insurance cover', text: ' – Public liability (minimum £1M) and professional indemnity' },
                    { bold: 'Relevant experience', text: ' – Case studies and sample deliverables from similar projects' },
                    { bold: 'Processing capabilities', text: ' – In-house photogrammetry for quality control and faster turnaround' },
                  ].map((item, index) => (
                ...
                <div className="bg-teal rounded-xl p-5">
                  <p className="text-white font-semibold mb-3">Ready to work with a trusted survey provider?</p>
              ...
              {/* Are Drone Surveys Worth the Investment? */}
              <div>
                <h2 id="worth-investment" className="text-2xl md:text-3xl font-bold text-teal mb-4 scroll-mt-32">
                  Are <span className="text-gold">Drone Surveys</span> Worth the Investment?
                </h2>
                <p className="text-text-secondary text-lg leading-relaxed mb-6">
                  For the vast majority of projects, yes. The combination of lower costs, faster delivery, and comprehensive data makes drone surveys the obvious choice over traditional methods for sites larger than a few hundred square metres. When you factor in reduced site disruption and the richness of the 3D data produced, the value proposition becomes compelling. A drone survey costing £700 can replace a traditional survey that would have cost £1,500-£2,000 while delivering more comprehensive outputs.
                </p>
                  ...
                  <div className="bg-background-alt border border-border rounded-xl p-6">
                    ...
                    <ul className="space-y-2 text-text-secondary text-sm">
                      <li className="flex justify-between">
                        <span>Survey team (2-3 days)</span>
                        <span className="font-semibold">£1,200-£3,000</span>
                      </li>
                      <li className="flex justify-between">
                        <span>Equipment & travel</span>
                        <span className="font-semibold">£200-£500</span>
                      </li>
                      <li className="flex justify-between">
                        <span>Processing & CAD drafting</span>
                      ...
                      <li className="flex justify-between border-t border-border pt-2 mt-2">
                        ...
                        <span className="font-bold text-red-500">£1,700-£4,300</span>
                      </li>
                    </ul>
                  </div>
                  <div className="bg-teal/10 border border-teal/20 rounded-xl p-6">
                    <h4 className="font-bold text-teal mb-4">Drone Survey</h4>
                    <ul className="space-y-2 text-text-secondary text-sm">
                      <li className="flex justify-between">
                ...
                <div className="bg-gradient-to-r from-teal to-teal-dark rounded-xl p-6 text-center">
                  <h3 className="text-white font-bold text-xl mb-2">Ready to Survey Your Site?</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-border rounded-2xl p-6">
                ...
                <p className="text-text-secondary text-sm leading-relaxed">
                  With extensive experience in UAV surveying and photogrammetry, Peter personally oversees every survey project to ensure accurate, reliable data you can build upon.
                </p>
              </div>
              ...
              <div className="bg-background-alt border border-border rounded-2xl p-6">
                <h3 className="text-teal font-bold text-lg mb-4">
                  Quick Guide: Drone Surveys Explained
                </h3>
                <nav className="space-y-2">
                  {[
                    { id: 'what-are-drone-surveys', label: 'What Are Drone Surveys?' },
                    { id: 'drone-survey-cost', label: 'How Much Do Drone Surveys Cost?' },
                    { id: 'drone-vs-traditional', label: 'Drone vs Traditional Methods' },
                    { id: 'drone-survey-accuracy', label: 'What Accuracy Can Be Achieved?' },
                    { id: 'types-of-drone-surveys', label: 'Types of Drone Surveys' },
                    { id: 'drone-survey-deliverables', label: 'What Deliverables Do You Receive?' },
                    { id: 'survey-timeline', label: 'How Long Does a Survey Take?' },
                    { id: 'choose-provider', label: 'How to Choose a Provider' },
                    { id: 'worth-investment', label: 'Are Drone Surveys Worth It?' },
                  ].map((item) => (
                    <a
                      key={item.id}
                      href={`#${item.id}`}
              ...
              <div className="bg-teal rounded-2xl p-6">
                ...
                <ul className="space-y-3">
                  {[
                    'Orthomosaic maps',
                    'Digital terrain models (DTM/DSM)',
      ...
      <section className="py-16 bg-background-alt">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <h3 className="text-teal font-bold text-lg mb-2">Topographical Surveys</h3>
              <p className="text-text-secondary text-sm">
                Detailed elevation mapping with contour data for planning and design applications.
              </p>
            </Link>
            <Link
              ...
              className="bg-white border border-border rounded-xl p-6 hover:border-gold hover:shadow-lg transition-all duration-300"
            >
              <h3 className="text-teal font-bold text-lg mb-2">Point Cloud Mapping</h3>
              <p className="text-text-secondary text-sm">
                High-density 3D point clouds from photogrammetry and LiDAR for BIM integration.
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-text-secondary text-sm">
                Regular progress surveys to track build stages and compare against design models.
              </p>
            </Link>
          </div>
        </div>
