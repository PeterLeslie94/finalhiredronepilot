...
export const metadata: Metadata = {
  title: 'Drone Roof Inspection Services | UAV Roof Surveys UK | Skykam Drone Inspections',
  ...
  return (
    <>
      <ServiceSchema
        ...
        description="Expert UAV roof inspection services throughout the UK. Secure, comprehensive drone assessments with thermal scanning. CAA certified drone pilots. Zero scaffolding needed."
        url="https://skykam.co.uk/services/drone-roof-survey"
      />
      <BreadcrumbSchema items={[
        { name: "Home", url: "https://skykam.co.uk" },
        { name: "Services", url: "https://skykam.co.uk/services" },
        { name: "Drone Roof Survey Services", url: "https://skykam.co.uk/services/drone-roof-survey" }
      ]} />
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div>
                ...
                <p className="text-text-secondary text-lg leading-relaxed">
                  At Skykam Drone Inspections, we operate cutting-edge camera drones fitted with high-resolution sensors and optional thermal detection capabilities. This enables us to pinpoint defects, deterioration, and areas of concern that remain invisible from ground level—and frequently escape notice during conventional rooftop inspections.
                </p>
              ...
              <div>
                ...
                <p className="text-text-secondary text-lg leading-relaxed mb-6">
                  At Skykam Drone Inspections, we satisfy every criterion. We're CAA certified, comprehensively insured, and have performed roof assessments for facilities managers, chartered surveyors, and property owners throughout the UK.
                </p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-border rounded-2xl p-6">
                ...
                <p className="text-text-secondary text-sm leading-relaxed">
                  With broad expertise in UAV surveying and structural inspections, James personally supervises every roof assessment to guarantee thorough, precise documentation you can depend on.
                </p>
              </div>
