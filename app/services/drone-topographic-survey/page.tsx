...
export const metadata: Metadata = {
  title: 'Drone Topographic Survey Solutions | UK Terrain Mapping Specialists | Skykam Drone Inspections',
  ...
  return (
    <>
      <ServiceSchema
        ...
        description="Expert UAV topographic survey solutions throughout the UK. Precision terrain modelling, contour generation, and survey-grade data for planning. CAA approved drone operators."
        url="https://skykam.co.uk/services/drone-topographic-survey"
      />
      <BreadcrumbSchema items={[
        { name: "Home", url: "https://skykam.co.uk" },
        { name: "Services", url: "https://skykam.co.uk/services" },
        { name: "Drone Topographic Survey Services", url: "https://skykam.co.uk/services/drone-topographic-survey" }
      ]} />
      {/* Hero Section */}
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div>
                ...
                <p className="text-text-secondary text-lg leading-relaxed">
                  Skykam Drone Inspections produces RICS-compliant topographic data that satisfies the demands of planning departments, architectural practices, and civil engineering firms. Our photogrammetry methodology suits open land, active construction zones, and development plots requiring accurate ground elevations, boundary delineation, and feature mapping.
                </p>
              ...
              <div>
                ...
                <p className="text-text-secondary text-lg leading-relaxed mb-6">
                  Skykam Drone Inspections meets every criterion. We hold CAA approval, carry comprehensive insurance, and have completed topographic surveys for planning submissions, engineering works, and developments throughout the UK.
                </p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-border rounded-2xl p-6">
                ...
                <p className="text-text-secondary text-sm leading-relaxed">
                  Drawing on substantial surveying and UAV expertise, James directly supervises each topographic project to guarantee survey-grade precision and professional results.
                </p>
              </div>
