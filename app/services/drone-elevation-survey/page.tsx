...
export const metadata: Metadata = {
  title: 'UAV Elevation Survey Solutions | Building Facade Survey UK | Skykam Drone Inspections',
  ...
  return (
    <>
      <ServiceSchema
        ...
        description="Expert UAV elevation survey solutions throughout the UK. Orthorectified facade imagery, precise measurements, and detailed building elevations. CAA authorised drone operators."
        url="https://skykam.co.uk/services/drone-elevation-survey"
      />
      <BreadcrumbSchema items={[
        { name: "Home", url: "https://skykam.co.uk" },
        { name: "Services", url: "https://skykam.co.uk/services" },
        { name: "UAV Elevation Survey Solutions", url: "https://skykam.co.uk/services/drone-elevation-survey" }
      ]} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div>
                ...
                <p className="text-text-secondary text-lg leading-relaxed mb-6">
                  At Skykam Drone Inspections, we satisfy every criterion. We are CAA authorised, fully insured, and have delivered elevation surveys for heritage buildings, commercial properties, and residential developments throughout the UK.
                </p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-border rounded-2xl p-6">
                ...
                <p className="text-text-secondary text-sm leading-relaxed">
                  With extensive experience in surveying and UAV operations, James personally oversees every elevation survey to ensure accurate, professional deliverables.
                </p>
              </div>
