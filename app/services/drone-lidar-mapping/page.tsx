...
export const metadata: Metadata = {
  title: 'UAV LiDAR Survey Services | LiDAR Mapping UK | Hire Drone Pilot',
  ...
  return (
    <>
      <ServiceSchema
        ...
        description="Expert UAV LiDAR survey services throughout the UK. Vegetation penetration, DTM creation, and high-precision 3D point cloud data. CAA certified drone operators."
        url="https://hiredronepilot.uk/services/drone-lidar-mapping"
      />
      <BreadcrumbSchema items={[
        { name: "Home", url: "https://hiredronepilot.uk" },
        { name: "Services", url: "https://hiredronepilot.uk/services" },
        { name: "UAV LiDAR Survey Services", url: "https://hiredronepilot.uk/services/drone-lidar-mapping" }
      ]} />
      {/* Hero Section */}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-border rounded-2xl p-6">
                ...
                <p className="text-text-secondary text-sm leading-relaxed">
                  With extensive experience in surveying and UAV operations, Peter personally supervises every LiDAR project to guarantee survey-grade precision and expert delivery.
                </p>
              </div>
