...
export const metadata: Metadata = {
  title: 'Drone Solar Farm Survey Solutions | Solar Panel Inspection UK | Skykam Drone Inspections',
  ...
  return (
    <>
      <ServiceSchema
        ...
        url="https://skykam.co.uk/services/drone-solar-farm-survey"
      />
      <BreadcrumbSchema items={[
        { name: "Home", url: "https://skykam.co.uk" },
        { name: "Services", url: "https://skykam.co.uk/services" },
        { name: "Drone Solar Farm Survey Services", url: "https://skykam.co.uk/services/drone-solar-farm-survey" }
      ]} />
      {/* Hero Section */}
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div>
                ...
                <p className="text-text-secondary text-lg leading-relaxed">
                  At Skykam Drone Inspections, we merge high-resolution RGB imagery with radiometric thermal sensors capable of detecting temperature variations as minute as 0.05 degrees Celsius. This precision enables us to pinpoint hotspots, bypass diode failures, cell fractures, and soiling problems that diminish your energy output and can cause expensive damage if left unaddressed.
                </p>
              ...
              <div>
                ...
                <p className="text-text-secondary text-lg leading-relaxed mb-6">
                  At Skykam Drone Inspections, we satisfy every criterion. We're CAA certified, comprehensively insured, and have completed solar farm inspections for asset owners, investors, and O&M providers throughout Britain.
                </p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-border rounded-2xl p-6">
                ...
                <p className="text-text-secondary text-sm leading-relaxed">
                  With considerable expertise in surveying and UAV operations, James personally manages every solar farm inspection to ensure precise fault identification and professional delivery.
                </p>
              </div>
              ...
              <div className="bg-teal rounded-2xl p-6 sticky top-32">
                ...
                <form name="sidebar-quote-solar" method="POST" data-netlify="true" className="space-y-3">
