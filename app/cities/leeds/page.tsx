...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Leeds.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Leeds construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/drone-volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across West Yorkshire.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/drone-lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Leeds building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Leeds.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Leeds and West Yorkshire.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Leeds project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all equipment. We handle all CAA regulations and site-specific risk assessments for Leeds operations.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Leeds using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Finance & Banking', Icon: Building2, description: 'Leeds financial district, banking headquarters' },
  { name: 'Legal Services', Icon: Scale, description: 'Law firms, commercial property, due diligence' },
  { name: 'Property Development', Icon: HomeIcon, description: 'South Bank, city centre regeneration projects' },
  { name: 'Construction', Icon: HardHat, description: 'Major developments, infrastructure projects' },
  { name: 'Energy & Utilities', Icon: Zap, description: 'Yorkshire Water, Northern Powergrid, infrastructure' },
  { name: 'Transport', Icon: Train, description: 'HS2, Northern Rail, Leeds Bradford Airport' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across West Yorkshire.',
  },
  {
    name: 'Fully Insured',
...
const leedsAreas = [
  {
    region: 'Leeds City Centre',
    boroughs: ['City Centre', 'South Bank', 'Holbeck', 'Hunslet', 'Wellington Place'],
  },
  {
    region: 'North Leeds',
    boroughs: ['Headingley', 'Chapel Allerton', 'Roundhay', 'Moortown', 'Meanwood'],
  },
  {
    region: 'South Leeds',
    boroughs: ['Beeston', 'Middleton', 'Belle Isle', 'Rothwell', 'Morley'],
  },
  {
    region: 'East Leeds',
    boroughs: ['Cross Gates', 'Seacroft', 'Garforth', 'Temple Newsam', 'Halton'],
  },
  {
    region: 'West Yorkshire',
    boroughs: ['Bradford', 'Wakefield', 'Huddersfield', 'Halifax', 'Dewsbury'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near Leeds Bradford Airport?',
    answer: 'Yes, we hold the necessary CAA permissions and can obtain clearances for flights near Leeds Bradford Airport\'s controlled airspace. We coordinate directly with air traffic control and handle all the complex airspace permissions so you don\'t have to.',
  },
  {
    question: 'How much does a drone survey cost in Leeds?',
    answer: 'Leeds drone survey costs vary based on site size, complexity, airspace requirements, and deliverables needed. As a guide, small site surveys start from around £500, while larger commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Leeds project.',
  },
  {
    question: 'How quickly can you respond to Leeds projects?',
    answer: 'We can typically mobilise for Leeds projects within 24-48 hours for urgent requirements. Our experienced team is well-versed in obtaining rapid airspace permissions when needed. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place.',
  },
  {
    question: 'Do you cover all of West Yorkshire?',
    answer: 'Yes, we provide comprehensive drone survey services across all of West Yorkshire including Leeds, Bradford, Wakefield, Huddersfield, Halifax, and surrounding areas. No location is too challenging for our experienced team.',
  },
  {
    question: 'What Leeds projects have you completed?',
    answer: 'We\'ve completed numerous projects across West Yorkshire including construction monitoring at major city centre developments, infrastructure inspections, commercial property surveys for legal and financial services clients, and topographic surveys for planning applications. Our experience covers everything from South Bank regeneration to rural Yorkshire estates.',
  },
  {
    question: 'How accurate are your Leeds drone surveys?',
    answer: 'Our Leeds drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'Can you survey commercial properties for legal purposes?',
    answer: 'Yes, we regularly provide drone surveys for legal and financial due diligence, boundary disputes, and commercial property transactions. Our surveys are conducted to RICS standards and our reports are suitable for legal proceedings and financial assessments.',
  },
  {
    question: 'What deliverables do you provide for Leeds projects?',
...
export default function LeedsPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Leeds' Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Leeds</>}
        description="Expert drone survey services across West Yorkshire. CAA-approved drone operators delivering precision aerial data for finance, legal, property, and construction projects throughout the region."
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Leeds Airspace Experts</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid Leeds Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Hire Drone Pilot drone pilot operating professional survey drone in Leeds"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-teal font-bold text-lg">180+</p>
                      <p className="text-text-secondary text-sm">Leeds Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Leeds</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  all of West Yorkshire. From city centre commercial developments to rural
                  estates, we have the expertise and permissions to operate anywhere.
                </p>
                <p>
                  Our team of CAA-certified drone pilots and qualified surveyors have completed
                  hundreds of projects across the region, from South Bank to Bradford,
                  Headingley to Wakefield.
                </p>
              </div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Leeds Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Hire Drone Pilot in Leeds
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Leeds projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Leeds Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Leeds project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Leeds project?</p>
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Ready to Discuss Your Leeds Project?
            </h3>
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Leeds drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Leeds projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Hire Drone Pilot Across West Yorkshire
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across all of West Yorkshire
              and the Leeds City Region. No location is too challenging.
            </p>
          </div>
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['South Bank', 'Wellington Place', 'Leeds Dock', 'City Centre', 'Holbeck Urban Village', 'Temple Green', 'Thorpe Park', 'White Rose'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Leeds drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Leeds drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  West Yorkshire including airport coordination.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Leeds project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Leeds.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Leeds Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Leeds drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Leeds airspace expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Leeds */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: safeJsonLd({
            ...
            '@type': 'LocalBusiness',
            name: 'Hire Drone Pilot Leeds',
            alternateName: 'HireDronePilot',
            description: 'Professional drone survey services in Leeds and West Yorkshire. CAA-approved drone operators delivering precision aerial data for finance, legal, property, and construction projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://hiredronepilot.uk/cities/leeds',
            areaServed: [
              ...
              { '@type': 'AdministrativeArea', name: 'Huddersfield' },
              { '@type': 'AdministrativeArea', name: 'Halifax' },
              { '@type': 'AdministrativeArea', name: 'Dewsbury' },
            ],
            geo: {
              '@type': 'GeoCoordinates',
              latitude: 53.8008,
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Leeds Hire Drone Pilot',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Leeds',
                  },
                },
                {
                  '@type': 'Offer',
