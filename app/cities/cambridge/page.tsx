...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Cambridge.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Cambridge construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Cambridgeshire.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/drone-lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Cambridge building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Cambridge.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Cambridge and surrounding areas.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Cambridge project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all equipment. We handle all CAA regulations and site-specific risk assessments for Cambridge locations.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Cambridge using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Biotech & Life Sciences', Icon: FlaskConical, description: 'Cambridge Science Park, Granta Park, research facilities' },
  { name: 'Technology', Icon: Building2, description: 'Tech startups, software companies, innovation centres' },
  { name: 'University & Education', Icon: GraduationCap, description: 'Cambridge University colleges, research buildings, campus surveys' },
  { name: 'Research Institutes', Icon: Microscope, description: 'Wellcome Trust, MRC, Babraham Institute facilities' },
  { name: 'Property Development', Icon: HomeIcon, description: 'New developments, residential projects, commercial property' },
  { name: 'Agriculture', Icon: Leaf, description: 'Farming surveys, crop monitoring, rural land management' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Cambridgeshire.',
  },
  {
    name: 'Fully Insured',
...
const cambridgeAreas = [
  {
    region: 'Cambridge City',
    boroughs: ['City Centre', 'Mill Road', 'Romsey', 'Chesterton', 'Arbury'],
  },
  {
    region: 'South Cambridgeshire',
    boroughs: ['Sawston', 'Great Shelford', 'Trumpington', 'Fulbourn', 'Linton'],
  },
  {
    region: 'East Cambridgeshire',
    boroughs: ['Ely', 'Soham', 'Littleport', 'Burwell', 'Haddenham'],
  },
  {
    region: 'Huntingdonshire',
    boroughs: ['Huntingdon', 'St Ives', 'St Neots', 'Ramsey', 'Godmanchester'],
  },
  {
    region: 'Fenland',
    boroughs: ['March', 'Wisbech', 'Whittlesey', 'Chatteris'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near Cambridge Airport?',
    answer: 'Yes, we hold the necessary CAA permissions and can obtain clearances for flights near Cambridge Airport and other controlled airspace in the region. We handle all the complex airspace permissions so you don\'t have to, ensuring full compliance with aviation regulations.',
  },
  {
    question: 'How much does a drone survey cost in Cambridge?',
    answer: 'Cambridge drone survey costs vary based on site size, complexity, and deliverables needed. As a guide, small site surveys start from around £500, while larger commercial or research facility projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Cambridge project.',
  },
  {
    question: 'Do you work with Cambridge University and research institutions?',
    answer: 'Yes, we have extensive experience working with academic and research institutions. We understand the unique requirements of university campuses, historic buildings, and research facilities. Our team can accommodate specific data formats and reporting requirements needed for academic projects.',
  },
  {
    question: 'Can you survey biotech and science park facilities?',
    answer: 'Absolutely. We regularly survey facilities at Cambridge Science Park, Granta Park, and other biotech clusters. We understand security protocols and can work within restricted access environments while maintaining confidentiality of sensitive sites.',
  },
  {
    question: 'How quickly can you respond to Cambridge projects?',
    answer: 'We can typically mobilise for Cambridge projects within 24-48 hours for urgent requirements. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place and optimal survey conditions.',
  },
  {
    question: 'What deliverables do you provide for Cambridge projects?',
  ...
  {
    question: 'Do you cover agricultural land in Cambridgeshire?',
    answer: 'Yes, we provide comprehensive agricultural drone surveys across Cambridgeshire\'s farming areas. Services include crop health monitoring, drainage surveys, field mapping, and land management assessments using multispectral and thermal imaging.',
  },
  {
    question: 'How accurate are your Cambridge drone surveys?',
    answer: 'Our Cambridge drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
];
...
export default function CambridgePage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Cambridge's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Cambridge</>}
        description="Expert drone survey services across Cambridge and Cambridgeshire. CAA-approved drone operators delivering precision aerial data for biotech, research, university, and construction projects."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Cambridge Drone Survey Experts
              </p>
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Professional Kit. <span className="text-wipe-red">Cambridge Expertise.</span> <span className="underline-sweep">Research-Grade Results.</span>
              </h2>
              <p className="text-text-secondary text-lg mb-6 leading-relaxed">
                Cambridge is home to world-leading research institutions, biotech companies, and
                historic university buildings. You need drone survey operators who understand
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Research Institution Experience</p>
                    <p className="text-text-secondary text-sm">University & science park expertise</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid Cambridge Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Hire Drone Pilot drone pilot operating professional survey drone in Cambridge"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Cambridge Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Cambridge</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  Cambridge and Cambridgeshire. From biotech facilities to university campuses,
                  we have the expertise to handle any project.
                </p>
                <p>
                  Our team of CAA-certified drone pilots and qualified surveyors have completed
                  numerous projects across the region, from Cambridge Science Park to the
                  historic city centre colleges.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  ...
                  <p className="text-text-secondary text-sm">Districts Covered</p>
                </div>
                <div className="text-center">
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Cambridge Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Hire Drone Pilot in Cambridge
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Cambridge projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Cambridge Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Cambridge project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Cambridge project?</p>
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Ready to Discuss Your Cambridge Project?
            </h3>
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Cambridge drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Cambridge projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Hire Drone Pilot Across Cambridgeshire
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across Cambridge city
              and all Cambridgeshire districts. No location is too challenging.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {cambridgeAreas.map((area) => (
              <div
                key={area.region}
                className="bg-background-alt border border-border rounded-xl p-6 hover:border-gold hover:shadow-lg transition-all duration-300"
              >
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            <h4 className="text-white font-bold text-xl mb-4">Key Business & Research Areas</h4>
            <div className="flex flex-wrap justify-center gap-4">
              {['Cambridge Science Park', 'Granta Park', 'Babraham Research Campus', 'West Cambridge', 'Cambridge Biomedical Campus', 'St John\'s Innovation Centre', 'Peterhouse Technology Park', 'Vision Park'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Cambridge drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Cambridge drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Cambridgeshire with all necessary permissions.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Cambridge project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Cambridge.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Cambridge Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Cambridge drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Cambridge research expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Cambridge */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: safeJsonLd({
            ...
            '@type': 'LocalBusiness',
            name: 'Hire Drone Pilot Cambridge',
            alternateName: 'HireDronePilot',
            description: 'Professional drone survey services in Cambridge and Cambridgeshire. CAA-approved drone operators delivering precision aerial data for biotech, research, university, and construction projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://hiredronepilot.uk/cities/cambridge',
            areaServed: [
              { '@type': 'City', name: 'Cambridge' },
              { '@type': 'AdministrativeArea', name: 'Cambridgeshire' },
              { '@type': 'AdministrativeArea', name: 'South Cambridgeshire' },
              { '@type': 'AdministrativeArea', name: 'East Cambridgeshire' },
              { '@type': 'AdministrativeArea', name: 'Huntingdonshire' },
              { '@type': 'AdministrativeArea', name: 'Fenland' },
            ],
            geo: {
              '@type': 'GeoCoordinates',
              latitude: 52.2053,
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Cambridge Hire Drone Pilot',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Cambridge',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Cambridge',
                  },
                },
                {
                  '@type': 'Offer',
