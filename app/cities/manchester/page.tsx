...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Manchester.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Manchester construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Greater Manchester.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/drone-lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Manchester building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Manchester.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Manchester and Greater Manchester.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Manchester project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all equipment. We handle all CAA regulations and site-specific risk assessments for Manchester operations.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Manchester using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Media & Broadcasting', Icon: Monitor, description: 'MediaCityUK, BBC North, ITV Granada studios' },
  { name: 'Tech & Digital', Icon: Building2, description: 'Tech startups, data centres, digital infrastructure' },
  { name: 'Construction', Icon: HardHat, description: 'Spinningfields, NOMA, St John\'s Quarter developments' },
  { name: 'Energy & Utilities', Icon: Zap, description: 'United Utilities, Electricity North West, infrastructure' },
  { name: 'Real Estate', Icon: HomeIcon, description: 'Property marketing, roof surveys, boundary mapping' },
  { name: 'Transport', Icon: Train, description: 'Metrolink, Northern Rail, road infrastructure' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Greater Manchester.',
  },
  {
    name: 'Fully Insured',
...
const manchesterAreas = [
  {
    ...
    boroughs: ['Spinningfields', 'Ancoats', 'Northern Quarter', 'Castlefield', 'Piccadilly'],
  },
  {
    region: 'North Manchester',
    boroughs: ['Bury', 'Rochdale', 'Oldham', 'Prestwich', 'Middleton'],
  },
  {
    region: 'South Manchester',
    boroughs: ['Stockport', 'Didsbury', 'Chorlton', 'Sale', 'Altrincham'],
  },
  {
    region: 'East Manchester',
    boroughs: ['Tameside', 'Ashton-under-Lyne', 'Denton', 'Droylsden', 'Openshaw'],
  },
  {
    region: 'West Manchester',
    boroughs: ['Salford', 'Trafford', 'Eccles', 'Stretford', 'Urmston'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near Manchester Airport?',
    answer: 'Yes, we hold the necessary CAA permissions and can obtain clearances for flights near Manchester Airport\'s controlled airspace. We coordinate directly with air traffic control and handle all the complex airspace permissions so you don\'t have to.',
  },
  {
    question: 'How much does a drone survey cost in Manchester?',
    answer: 'Manchester drone survey costs vary based on site size, complexity, airspace requirements, and deliverables needed. As a guide, small site surveys start from around £500, while larger commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Manchester project.',
  },
  {
    question: 'How quickly can you respond to Manchester projects?',
    answer: 'We can typically mobilise for Manchester projects within 24-48 hours for urgent requirements. Our experienced team is well-versed in obtaining rapid airspace permissions when needed. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place.',
  },
  {
    question: 'Do you cover all of Greater Manchester?',
    answer: 'Yes, we provide comprehensive drone survey services across all ten Greater Manchester boroughs including Manchester, Salford, Trafford, Stockport, Tameside, Oldham, Rochdale, Bury, Bolton, and Wigan. No location is too challenging for our experienced team.',
  },
  {
    question: 'What Manchester projects have you completed?',
    answer: 'We\'ve completed numerous projects across Greater Manchester including construction monitoring at major city centre developments, infrastructure inspections for Metrolink, roof surveys for commercial properties, and topographic surveys for planning applications. Our experience covers everything from MediaCityUK to industrial sites.',
  },
  {
    question: 'How accurate are your Manchester drone surveys?',
    answer: 'Our Manchester drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'Can you survey construction sites in Manchester city centre?',
    answer: 'Yes, we regularly undertake drone surveys on active construction sites throughout Manchester city centre. We work closely with site managers and contractors, ensuring all health and safety requirements are met while delivering the aerial data you need.',
  },
  {
    question: 'What deliverables do you provide for Manchester projects?',
...
export default function ManchesterPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Manchester's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Manchester</>}
        description="Expert drone survey services across Greater Manchester. CAA-approved drone operators delivering precision aerial data for construction, media, tech, and infrastructure projects throughout the region."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Manchester Drone Survey Experts
              </p>
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Professional Kit. <span className="text-wipe-red">Manchester Expertise.</span> <span className="underline-sweep">Complex Projects Handled.</span>
              </h2>
              <p className="text-text-secondary text-lg mb-6 leading-relaxed">
                Manchester is a city of constant development and innovation. From MediaCityUK
                to Spinningfields, major construction projects to tech infrastructure,
              ...
              <p className="text-text-primary text-lg mb-8 leading-relaxed font-medium">
                ...
                <span className="text-teal"> local expertise</span> and enterprise-grade equipment.
                Every Manchester project we deliver is fully compliant and professional.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Manchester Airspace Experts</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid Manchester Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Hire Drone Pilot drone pilot operating professional survey drone in Manchester"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Manchester Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Manchester</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  all of Greater Manchester. From city centre construction sites to suburban
                  development projects, we have the expertise and permissions to operate anywhere.
                </p>
                <p>
                  Our team of CAA-certified drone pilots and qualified surveyors have completed
                  hundreds of projects across the region, from MediaCityUK to Manchester Airport,
                  Spinningfields to Stockport.
                </p>
              </div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Manchester Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Hire Drone Pilot in Manchester
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Manchester projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Manchester Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Manchester project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Manchester project?</p>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Drone Surveys for Manchester Sectors
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We deliver tailored drone survey solutions across Manchester's key industries.
            </p>
          </div>
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Ready to Discuss Your Manchester Project?
            </h3>
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Manchester drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Manchester projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Hire Drone Pilot Across Greater Manchester
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across all ten Greater Manchester
              boroughs. No location is too challenging.
            </p>
          </div>
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Spinningfields', 'MediaCityUK', 'NOMA', 'St John\'s Quarter', 'Piccadilly', 'Oxford Road Corridor', 'Trafford Park', 'Airport City'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Manchester drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Manchester drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Greater Manchester including airport coordination.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Manchester project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Manchester.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Manchester Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Manchester drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Manchester airspace expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Manchester */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: safeJsonLd({
            ...
            '@type': 'LocalBusiness',
            name: 'Hire Drone Pilot Manchester',
            alternateName: 'HireDronePilot',
            description: 'Professional drone survey services in Manchester and Greater Manchester. CAA-approved drone operators delivering precision aerial data for construction, media, tech, and infrastructure projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://hiredronepilot.uk/cities/manchester',
            areaServed: [
              ...
              { '@type': 'AdministrativeArea', name: 'Oldham' },
            ],
            geo: {
              '@type': 'GeoCoordinates',
              latitude: 53.4808,
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Manchester Hire Drone Pilot',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Manchester',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Manchester',
                  },
                },
                {
                  '@type': 'Offer',
