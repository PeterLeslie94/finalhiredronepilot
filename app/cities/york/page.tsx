...
const processSteps = [
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across York using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Hire Drone Pilot drone pilot operating professional survey drone in York"
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: safeJsonLd({
            ...
            url: 'https://hiredronepilot.uk/cities/york',
            areaServed: [
              { '@type': 'City', name: 'York' },
