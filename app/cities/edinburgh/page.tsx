...
const industries = [
  ...
  { name: 'Construction', Icon: HardHat, description: 'St Peter Quarter, Haymarket, major development projects' },
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'We\'ve completed numerous projects across Edinburgh including construction monitoring at St Peter Quarter, heritage surveys in the Old Town, roof inspections for commercial properties, and topographic surveys for planning applications throughout the Lothians.',
  },
  {
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Hire Drone Pilot drone pilot operating professional survey drone in Edinburgh"
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Hire Drone Pilot in Edinburgh
            </h3>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Hire Drone Pilot Across Edinburgh
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Charlotte Square', 'George Street', 'St Peter Quarter', 'Edinburgh Park', 'Quartermile', 'Haymarket', 'Leith', 'South Gyle'].map((district) => (
                <span
                  key={district}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Hire Drone Pilot Edinburgh',
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Edinburgh Hire Drone Pilot',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
