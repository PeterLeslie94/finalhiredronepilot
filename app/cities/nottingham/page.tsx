...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Nottingham.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Nottingham construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Nottinghamshire.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/drone-lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Nottingham building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Nottingham.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Nottingham and Nottinghamshire.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Nottingham project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all equipment. We handle all CAA regulations and site-specific risk assessments for your Nottingham project.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Nottingham using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Pharmaceutical', Icon: Pill, description: 'Boots, pharmaceutical manufacturing, research facilities' },
  { name: 'Retail & Logistics', Icon: ShoppingBag, description: 'Distribution centres, retail parks, warehouse surveys' },
  { name: 'University', Icon: GraduationCap, description: 'University of Nottingham, NTU campus developments' },
  { name: 'Construction', Icon: HardHat, description: 'City centre regeneration, Broadmarsh, Island Quarter' },
  { name: 'Commercial Property', Icon: Building2, description: 'Office developments, retail spaces, property surveys' },
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Nottingham and Nottinghamshire.',
  },
  {
    name: 'Fully Insured',
...
const nottinghamAreas = [
  {
    region: 'Nottingham City Centre',
    boroughs: ['City Centre', 'Lace Market', 'Hockley', 'The Park', 'Sneinton'],
  },
  {
    region: 'North Nottinghamshire',
    boroughs: ['Arnold', 'Carlton', 'Gedling', 'Mapperley', 'Bestwood'],
  },
  {
    region: 'South Nottinghamshire',
    boroughs: ['West Bridgford', 'Clifton', 'Ruddington', 'Beeston', 'Chilwell'],
  },
  {
    region: 'East Nottinghamshire',
    boroughs: ['Netherfield', 'Colwick', 'Burton Joyce', 'Radcliffe-on-Trent', 'Bingham'],
  },
  {
    region: 'West Nottinghamshire',
    boroughs: ['Wollaton', 'Bilborough', 'Strelley', 'Broxtowe', 'Stapleford'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near East Midlands Airport?',
    answer: 'Yes, we hold the necessary CAA permissions and can coordinate with East Midlands Airport for flights in controlled airspace. We handle all the complex airspace permissions and safety coordination so you don\'t have to. Our team has extensive experience operating in the Nottinghamshire area.',
  },
  {
    question: 'How much does a drone survey cost in Nottingham?',
    answer: 'Nottingham drone survey costs vary based on site size, complexity, and deliverables needed. As a guide, small site surveys start from around £500, while larger commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Nottingham project.',
  },
  {
    question: 'Do you work with pharmaceutical facilities?',
    answer: 'Yes, we have experience working with pharmaceutical and healthcare facilities across Nottingham, including compliance with strict security and operational requirements. Our team understands the specific protocols needed for these sensitive environments.',
  },
  {
    question: 'How quickly can you respond to Nottingham projects?',
    answer: 'We can typically mobilise for Nottingham projects within 24-48 hours for urgent requirements. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place and optimal flight conditions.',
  },
  {
    question: 'What Nottingham projects have you completed?',
    answer: 'We\'ve completed numerous projects across Nottingham and Nottinghamshire including construction monitoring at major developments, university campus surveys, retail park inspections, and topographic surveys for planning applications across the region.',
  },
  {
    question: 'How accurate are your Nottingham drone surveys?',
    answer: 'Our Nottingham drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'What areas of Nottinghamshire do you cover?',
    answer: 'We provide drone survey services across all of Nottingham and the wider Nottinghamshire area, including Mansfield, Newark, Worksop, and Retford. We also cover neighbouring counties including Derbyshire, Leicestershire, and Lincolnshire.',
  },
  {
    question: 'What deliverables do you provide for Nottingham projects?',
...
export default function NottinghamPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Nottingham's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Nottingham</>}
        description="Expert drone survey services across Nottingham and Nottinghamshire. CAA-approved drone operators delivering precision aerial data for pharmaceutical, retail, university, and construction projects."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Nottingham Drone Survey Experts
              </p>
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Professional Kit. <span className="text-wipe-red">East Midlands Expertise.</span> <span className="underline-sweep">Precision Delivered.</span>
              </h2>
              <p className="text-text-secondary text-lg mb-6 leading-relaxed">
                Nottingham is a hub for pharmaceutical, retail, and education sectors.
                From major distribution centres to university campuses, you need drone
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Multi-Sector Expertise</p>
                    <p className="text-text-secondary text-sm">Pharma, retail, education specialists</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Hire Drone Pilot drone pilot operating professional survey drone in Nottingham"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Nottingham Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Nottingham</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  Nottingham and Nottinghamshire. From pharmaceutical facilities to university
                  campuses, we have the expertise to deliver precision data.
                </p>
                <p>
                  Our team of CAA-certified drone pilots and qualified surveyors have completed
                  hundreds of projects across the region, from city centre developments to
                  distribution centres throughout the East Midlands.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-gold mb-1">8</p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Nottingham Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Hire Drone Pilot in Nottingham
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Nottingham projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Nottingham Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Nottingham project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Nottingham project?</p>
            <button
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            ...
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Nottingham drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Nottingham projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Hire Drone Pilot Across Nottinghamshire
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across Nottingham
              and all districts of Nottinghamshire.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {nottinghamAreas.map((area) => (
              <div
                key={area.region}
                className="bg-background-alt border border-border rounded-xl p-6 hover:border-gold hover:shadow-lg transition-all duration-300"
              >
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            <h4 className="text-white font-bold text-xl mb-4">Key Development Areas</h4>
            <div className="flex flex-wrap justify-center gap-4">
              {['Island Quarter', 'Broadmarsh', 'Boots Campus', 'University Park', 'Jubilee Campus', 'Castle Quarter', 'Creative Quarter', 'Waterside'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Nottingham drone operations.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Nottingham drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  Fully approved for commercial drone operations across Nottingham
                  and Nottinghamshire including near East Midlands Airport.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Nottingham project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Nottingham.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Nottingham Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Nottingham drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">East Midlands expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Nottingham */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Hire Drone Pilot Nottingham',
            alternateName: 'HireDronePilot',
            description: 'Professional drone survey services in Nottingham and Nottinghamshire. CAA-approved drone operators delivering precision aerial data for pharmaceutical, retail, university, and construction projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://hiredronepilot.uk/cities/nottingham',
            areaServed: [
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Nottingham Hire Drone Pilot',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Nottingham',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Nottingham',
                  },
                },
                {
                  '@type': 'Offer',
