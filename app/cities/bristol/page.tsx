...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Bristol.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Bristol construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/drone-volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Bristol and the South West.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/drone-lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Bristol building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Bristol.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Bristol and surrounding areas.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Bristol project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all required equipment. We handle all CAA regulations and site-specific risk assessments for Bristol operations.',
...
const industries = [
  { name: 'Aerospace', Icon: Plane, description: 'Airbus, Rolls-Royce, aerospace manufacturing facilities' },
  { name: 'Technology', Icon: Cpu, description: 'Tech startups, data centres, innovation hubs' },
  { name: 'Creative Industries', Icon: Palette, description: 'Film production, media, animation studios' },
  { name: 'Heritage', Icon: Landmark, description: 'Historic harbourside, conservation areas, listed buildings' },
  { name: 'Real Estate', Icon: HomeIcon, description: 'Property marketing, roof surveys, boundary mapping' },
  { name: 'Commercial Property', Icon: Building2, description: 'Office developments, Temple Quarter, enterprise zones' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Bristol airspace.',
  },
  {
    name: 'Fully Insured',
...
const bristolAreas = [
  {
    ...
    boroughs: ['City Centre', 'Harbourside', 'Temple Quarter', 'Old Market', 'Broadmead'],
  },
  {
    region: 'North Bristol',
    boroughs: ['Filton', 'Patchway', 'Bradley Stoke', 'Stoke Gifford', 'Westbury-on-Trym'],
  },
  {
    region: 'South Bristol',
    boroughs: ['Bedminster', 'Knowle', 'Hartcliffe', 'Whitchurch', 'Bishopsworth'],
  },
  {
    region: 'East Bristol',
    boroughs: ['St George', 'Kingswood', 'Fishponds', 'Stapleton', 'Eastville'],
  },
  {
    region: 'West Bristol',
    boroughs: ['Clifton', 'Redland', 'Hotwells', 'Ashton Gate', 'Long Ashton'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near Bristol Airport?',
    answer: 'Yes, we hold the necessary CAA permissions and can coordinate flights near Bristol Airport. We handle all airspace permissions and liaise with air traffic control where required. Our team is experienced in operating within controlled airspace zones.',
  },
  {
    question: 'How much does a drone survey cost in Bristol?',
    answer: 'Bristol drone survey costs vary based on site size, complexity, and deliverables needed. As a guide, small site surveys start from around £500, while larger commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Bristol project.',
  },
  {
    question: 'How quickly can you respond to Bristol projects?',
    answer: 'We can typically mobilise for Bristol projects within 24-48 hours for urgent requirements. Our team covers the entire South West region and has extensive experience working across Bristol. For planned projects, we recommend 1-2 weeks notice.',
  },
  {
    question: 'Do you work with aerospace companies at Filton?',
    answer: 'Yes, we have experience working with aerospace and defence clients in the Filton area, including facilities near the former Filton Airfield. We understand the security and compliance requirements for these sensitive sites and can obtain necessary clearances.',
  },
  {
    question: 'What Bristol projects have you completed?',
    answer: 'We\'ve completed numerous projects across Bristol including construction monitoring at Temple Quarter, infrastructure surveys for MetroBus routes, building inspections in the harbourside area, and topographic surveys for residential developments across North and South Bristol.',
  },
  {
    question: 'How accurate are your Bristol drone surveys?',
    answer: 'Our Bristol drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'What areas of Bristol do you cover?',
    answer: 'We provide drone survey services across all of Bristol and the surrounding areas including South Gloucestershire, North Somerset, and Bath. From central Bristol to the outskirts and beyond, no location is too challenging for our experienced team.',
  },
  {
    question: 'What deliverables do you provide for Bristol projects?',
...
export default function BristolPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Bristol's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Bristol</>}
        description="Expert drone survey services across Bristol and the South West. CAA-approved drone operators delivering precision aerial data for aerospace, technology, and construction projects throughout the region."
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Aerospace Experience</p>
                    <p className="text-text-secondary text-sm">Filton corridor & secure site access</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid Bristol Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Hire Drone Pilot drone pilot operating professional survey drone in Bristol"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Bristol Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Bristol</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  Bristol and the South West. From aerospace facilities at Filton to city centre
                  developments, we have the expertise and permissions to operate anywhere.
                </p>
                <p>
                  Our team of CAA-certified drone pilots and qualified surveyors have completed
                  hundreds of projects across the region, from Temple Quarter regeneration to
                  harbourside heritage surveys.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-gold mb-1">SW</p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Hire Drone Pilot in Bristol
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Bristol projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Bristol Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Bristol project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Bristol project?</p>
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            ...
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Bristol drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Bristol projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Hire Drone Pilot Across Bristol
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across all areas of Bristol
              and the surrounding region. No location is too challenging.
            </p>
          </div>
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Temple Quarter', 'Harbourside', 'Filton', 'Bristol & Bath Science Park', 'Aztec West', 'Emersons Green', 'Avonmouth', 'Portbury'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Bristol drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Bristol drone operations.
                </p>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Bristol project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Bristol.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Bristol Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Bristol drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">South West expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Bristol */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: safeJsonLd({
            ...
            '@type': 'LocalBusiness',
            name: 'Hire Drone Pilot Bristol',
            alternateName: 'HireDronePilot',
            description: 'Professional drone survey services in Bristol and the South West. CAA-approved drone operators delivering precision aerial data for aerospace, technology, and construction projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://hiredronepilot.uk/cities/bristol',
            areaServed: [
              ...
              { '@type': 'Place', name: 'Temple Quarter' },
            ],
            geo: {
              '@type': 'GeoCoordinates',
              latitude: 51.4545,
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Bristol Hire Drone Pilot',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Bristol',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Bristol',
                  },
                },
                {
                  '@type': 'Offer',
