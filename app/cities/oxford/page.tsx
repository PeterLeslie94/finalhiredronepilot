...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Oxford.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-surveys',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Oxford construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/drone-volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Oxfordshire.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/drone-lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Oxford building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/drone-thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Oxford.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/drone-topographical-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Oxford and surrounding areas.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Oxford project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all equipment. We handle all CAA regulations and site-specific risk assessments for Oxford locations.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Oxford using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Automotive', Icon: Car, description: 'BMW Mini plant, motorsport facilities, vehicle testing sites' },
  { name: 'University & Education', Icon: GraduationCap, description: 'Oxford University colleges, research buildings, campus surveys' },
  { name: 'Publishing & Media', Icon: BookOpen, description: 'Oxford University Press, publishing houses, media facilities' },
  { name: 'Research & Innovation', Icon: Microscope, description: 'Science parks, R&D facilities, innovation centres' },
  { name: 'Property Development', Icon: HomeIcon, description: 'New developments, residential projects, commercial property' },
  { name: 'Commercial Property', Icon: Building2, description: 'Office parks, business centres, retail developments' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Oxfordshire.',
  },
  {
    name: 'Fully Insured',
...
const oxfordAreas = [
  {
    region: 'Oxford City',
    boroughs: ['City Centre', 'Jericho', 'Summertown', 'Headington', 'Cowley'],
  },
  {
    region: 'South Oxfordshire',
    boroughs: ['Henley-on-Thames', 'Wallingford', 'Thame', 'Didcot', 'Wheatley'],
  },
  {
    region: 'West Oxfordshire',
    boroughs: ['Witney', 'Carterton', 'Chipping Norton', 'Woodstock', 'Burford'],
  },
  {
    region: 'Cherwell',
    boroughs: ['Banbury', 'Bicester', 'Kidlington', 'Deddington', 'Bloxham'],
  },
  {
    region: 'Vale of White Horse',
    boroughs: ['Abingdon', 'Faringdon', 'Wantage', 'Grove', 'Botley'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near RAF Brize Norton?',
    answer: 'Yes, we hold the necessary CAA permissions and can obtain clearances for flights near RAF Brize Norton and other controlled airspace in Oxfordshire. We handle all the complex airspace permissions so you don\'t have to, ensuring full compliance with military and civil aviation regulations.',
  },
  {
    question: 'How much does a drone survey cost in Oxford?',
    answer: 'Oxford drone survey costs vary based on site size, complexity, and deliverables needed. As a guide, small site surveys start from around £500, while larger commercial or industrial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Oxford project.',
  },
  {
    question: 'Do you work with Oxford University and colleges?',
    answer: 'Yes, we have extensive experience working with academic institutions and historic buildings. We understand the unique requirements of university campuses, listed buildings, and conservation areas. Our team can accommodate specific data formats and reporting requirements needed for academic and heritage projects.',
  },
  {
    question: 'Can you survey automotive and industrial facilities?',
    answer: 'Absolutely. We regularly survey industrial facilities including the BMW Mini plant area and motorsport venues. We understand security protocols and can work within restricted access environments while maintaining confidentiality of sensitive sites.',
  },
  {
    question: 'How quickly can you respond to Oxford projects?',
    answer: 'We can typically mobilise for Oxford projects within 24-48 hours for urgent requirements. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place and optimal survey conditions.',
  },
  {
    question: 'What deliverables do you provide for Oxford projects?',
  ...
  {
    question: 'Do you survey historic and listed buildings in Oxford?',
    answer: 'Yes, we specialise in surveying historic and listed buildings with minimal impact. Our drones can capture detailed imagery and 3D data of heritage structures for conservation, restoration, and planning purposes without the need for scaffolding or access equipment.',
  },
  {
    question: 'How accurate are your Oxford drone surveys?',
    answer: 'Our Oxford drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
];
...
export default function OxfordPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Oxford's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Oxford</>}
        description="Expert drone survey services across Oxford and Oxfordshire. CAA-approved drone operators delivering precision aerial data for automotive, university, research, and construction projects."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Oxford Drone Survey Experts
              </p>
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Professional Kit. <span className="text-wipe-red">Oxford Expertise.</span> <span className="underline-sweep">Heritage-Sensitive Approach.</span>
              </h2>
              <p className="text-text-secondary text-lg mb-6 leading-relaxed">
                Oxford combines world-renowned heritage architecture with cutting-edge automotive
                and research facilities. You need drone survey operators who understand
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Heritage Building Experience</p>
                    <p className="text-text-secondary text-sm">Listed buildings & conservation areas</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid Oxford Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Hire Drone Pilot drone pilot operating professional survey drone in Oxford"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Oxford Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Oxford</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  Oxford and Oxfordshire. From historic university buildings to modern
                  automotive facilities, we have the expertise to handle any project.
                </p>
                <p>
                  Our team of CAA-certified drone pilots and qualified surveyors have completed
                  numerous projects across the region, from Oxford city centre colleges to
                  industrial sites in the surrounding districts.
                </p>
              </div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Oxford Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Hire Drone Pilot in Oxford
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Oxford projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Oxford Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Oxford project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Oxford project?</p>
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Ready to Discuss Your Oxford Project?
            </h3>
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Oxford drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Oxford projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Hire Drone Pilot Across Oxfordshire
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across Oxford city
              and all Oxfordshire districts. No location is too challenging.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {oxfordAreas.map((area) => (
              <div
                key={area.region}
                className="bg-background-alt border border-border rounded-xl p-6 hover:border-gold hover:shadow-lg transition-all duration-300"
              >
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Oxford Science Park', 'Oxford Business Park', 'Begbroke Science Park', 'Harwell Campus', 'Milton Park', 'Culham Science Centre', 'Headington', 'Cowley Works'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Oxford drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Oxford drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Oxfordshire with all necessary permissions.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Oxford project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Oxford.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Oxford Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Oxford drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Oxford heritage expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Oxford */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: safeJsonLd({
            ...
            '@type': 'LocalBusiness',
            name: 'Hire Drone Pilot Oxford',
            alternateName: 'HireDronePilot',
            description: 'Professional drone survey services in Oxford and Oxfordshire. CAA-approved drone operators delivering precision aerial data for automotive, university, research, and construction projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://hiredronepilot.uk/cities/oxford',
            areaServed: [
              ...
              { '@type': 'AdministrativeArea', name: 'Cherwell' },
              { '@type': 'AdministrativeArea', name: 'Vale of White Horse' },
            ],
            geo: {
              '@type': 'GeoCoordinates',
              latitude: 51.7520,
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Oxford Hire Drone Pilot',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Oxford',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Oxford',
                  },
                },
                {
                  '@type': 'Offer',
