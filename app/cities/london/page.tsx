...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across London.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for London construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/drone-volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Greater London.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/drone-lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for London building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in London.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Central and Greater London.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your London project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains London airspace permissions, and prepares all necessary equipment. We handle all CAA regulations, NATS clearances, and site-specific risk assessments.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across London using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Construction', Icon: HardHat, description: 'Canary Wharf, Nine Elms, King\'s Cross developments' },
  { name: 'Commercial Property', Icon: Building2, description: 'Office buildings, retail spaces, property surveys' },
  { name: 'Energy & Utilities', Icon: Zap, description: 'Thames Water, UK Power Networks, infrastructure' },
  { name: 'Heritage', Icon: Landmark, description: 'Historic buildings, conservation areas, listed properties' },
  { name: 'Real Estate', Icon: HomeIcon, description: 'Property marketing, roof surveys, boundary mapping' },
  { name: 'Transport', Icon: Train, description: 'TfL, Crossrail, railway and road infrastructure' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations in London controlled airspace.',
  },
  {
    name: 'Fully Insured',
...
const londonAreas = [
  {
    ...
    boroughs: ['City of London', 'Westminster', 'Kensington & Chelsea', 'Camden', 'Islington'],
  },
  {
    region: 'North London',
    boroughs: ['Barnet', 'Enfield', 'Haringey', 'Hackney', 'Waltham Forest'],
  },
  {
    region: 'South London',
    boroughs: ['Southwark', 'Lambeth', 'Lewisham', 'Greenwich', 'Croydon', 'Bromley'],
  },
  {
    region: 'East London',
    boroughs: ['Tower Hamlets', 'Newham', 'Barking & Dagenham', 'Redbridge', 'Havering'],
  },
  {
    region: 'West London',
    boroughs: ['Hammersmith & Fulham', 'Ealing', 'Hounslow', 'Hillingdon', 'Brent'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones in Central London?',
    answer: 'Yes, we hold the necessary CAA permissions and can obtain NATS clearances for flights in London\'s controlled airspace. This includes areas near Heathrow, City Airport, and the central London Flight Restriction Zone. We handle all the complex airspace permissions so you don\'t have to.',
  },
  {
    question: 'How much does a drone survey cost in London?',
    answer: 'London drone survey costs vary based on site size, complexity, airspace requirements, and deliverables needed. As a guide, small site surveys in London start from around £600, while larger commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific London project.',
  },
  {
    question: 'How quickly can you respond to London projects?',
    answer: 'We can typically mobilise for London projects within 24-48 hours for urgent requirements. Our experienced team is well-versed in obtaining rapid airspace permissions when needed. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place.',
  },
  {
    question: 'Do you have permissions for Heathrow and City Airport areas?',
    answer: 'Yes, our team regularly operates in the controlled airspace around both Heathrow and London City Airport. We have established relationships with NATS and can obtain the necessary permissions for flights in these restricted zones. Each flight is carefully coordinated to ensure aviation safety.',
  },
  {
    question: 'What London projects have you completed?',
    answer: 'We\'ve completed numerous projects across Greater London including construction monitoring at major developments, infrastructure inspections for TfL, roof surveys for commercial properties, and topographic surveys for planning applications. Our experience covers everything from historic conservation areas to major construction sites.',
  },
  {
    question: 'How accurate are your London drone surveys?',
    answer: 'Our London drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'What areas of London do you cover?',
    answer: 'We provide drone survey services across all 32 London boroughs plus the City of London. This includes Central, North, South, East, and West London, as well as the surrounding Home Counties. No London location is too challenging for our experienced team.',
  },
  {
    question: 'What deliverables do you provide for London projects?',
...
export default function LondonPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="London's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> London</>}
        description="Expert drone survey services across Greater London. CAA-approved drone operators delivering precision aerial data for construction, infrastructure, and property projects throughout the capital."
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">London Airspace Experts</p>
                    <p className="text-text-secondary text-sm">NATS coordination & FRZ permissions</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid London Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Hire Drone Pilot drone pilot operating professional survey drone in London"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-teal font-bold text-lg">500+</p>
                      <p className="text-text-secondary text-sm">London Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">London</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  all of Greater London. From Central London construction sites to suburban
                ...
                <p>
                  ...
                  hundreds of projects across the capital, from Canary Wharf to Heathrow,
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-gold mb-1">32</p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              London Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Hire Drone Pilot in London
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for London projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our London Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your London project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your London project?</p>
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            ...
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your London drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for London projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Hire Drone Pilot Across Greater London
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across all 32 London boroughs
              plus the City of London. No location is too challenging.
            </p>
          </div>
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Canary Wharf', 'The City', 'Nine Elms', 'King\'s Cross', 'Stratford', 'White City', 'Battersea', 'Greenwich Peninsula'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all London drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all London drone operations.
                </p>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  London project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in London.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free London Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your London drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">London airspace expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - London */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: safeJsonLd({
            ...
            '@type': 'LocalBusiness',
            name: 'Hire Drone Pilot London',
            alternateName: 'HireDronePilot',
            description: 'Professional drone survey services in London and Greater London. CAA-approved drone operators delivering precision aerial data for construction, infrastructure, and land projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://hiredronepilot.uk/cities/london',
            areaServed: [
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'London Hire Drone Pilot',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey London',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey London',
                  },
                },
                {
                  '@type': 'Offer',
