...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Plymouth.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Plymouth naval and construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Plymouth and Devon.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Plymouth building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Plymouth.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Plymouth and surrounding areas.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Plymouth project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all required equipment. We handle all CAA regulations and site-specific risk assessments for Plymouth operations.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Plymouth using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Naval & Defence', Icon: Anchor, description: 'HMNB Devonport, naval dockyard, defence facilities' },
  { name: 'Marine & Maritime', Icon: Waves, description: 'Plymouth Sound, marine research, coastal facilities' },
  { name: 'University & Research', Icon: GraduationCap, description: 'University of Plymouth, marine research, campus surveys' },
  { name: 'Heritage', Icon: Landmark, description: 'Royal Citadel, Barbican, historic waterfront' },
  { name: 'Real Estate', Icon: HomeIcon, description: 'Property marketing, roof surveys, boundary mapping' },
  { name: 'Commercial Property', Icon: Building2, description: 'Drake Circus, Derry\'s Cross, waterfront developments' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Plymouth airspace.',
  },
  {
    name: 'Fully Insured',
...
const plymouthAreas = [
  {
    ...
    boroughs: ['City Centre', 'The Barbican', 'Sutton Harbour', 'Millbay', 'West Hoe'],
  },
  {
    region: 'North Plymouth',
    boroughs: ['Crownhill', 'Derriford', 'Estover', 'Glenholt', 'Woolwell'],
  },
  {
    region: 'East Plymouth',
    boroughs: ['Plympton', 'Plymstock', 'Elburton', 'Hooe', 'Laira'],
  },
  {
    region: 'West Plymouth',
    boroughs: ['Devonport', 'Stoke', 'Stonehouse', 'Keyham', 'St Budeaux'],
  },
  {
    region: 'Surrounding Areas',
    boroughs: ['Saltash', 'Ivybridge', 'South Hams', 'Tavistock', 'Torpoint'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near HMNB Devonport?',
    answer: 'Yes, we can coordinate drone operations near HMNB Devonport with the appropriate permissions. We have experience working in areas with MOD restrictions and can obtain the necessary clearances through proper channels. All flights are conducted in full compliance with security protocols.',
  },
  {
    question: 'How much does a drone survey cost in Plymouth?',
    answer: 'Plymouth drone survey costs vary based on site size, complexity, security requirements, and deliverables needed. As a guide, small site surveys start from around £500, while larger naval or marine projects are priced based on specific requirements. Contact us for a free, no-obligation quote.',
  },
  {
    question: 'How quickly can you respond to Plymouth projects?',
    answer: 'We can typically mobilise for Plymouth projects within 24-48 hours for urgent requirements. However, projects near naval installations may require additional lead time for security clearances. For planned projects, we recommend 2-3 weeks notice for sensitive locations.',
  },
  {
    question: 'Do you work with marine research organisations?',
    answer: 'Yes, we have experience working with marine research institutions including the University of Plymouth and Plymouth Marine Laboratory. We understand the specific requirements for coastal and marine surveys, including cliff erosion monitoring, coastal mapping, and harbour surveys.',
  },
  {
    question: 'What Plymouth projects have you completed?',
    answer: 'We\'ve completed numerous projects across Plymouth including heritage surveys at the Barbican, building inspections for waterfront developments, coastal erosion monitoring, and topographic surveys for residential projects. Our experience covers both civilian and security-sensitive environments.',
  },
  {
    question: 'How accurate are your Plymouth drone surveys?',
    answer: 'Our Plymouth drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'What areas of Plymouth do you cover?',
    answer: 'We provide drone survey services across all of Plymouth and the surrounding Devon and Cornwall areas including Saltash, Ivybridge, and the South Hams. From Plymouth Sound to Dartmoor, no location is too challenging for our experienced team.',
  },
  {
    question: 'What deliverables do you provide for Plymouth projects?',
...
export default function PlymouthPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Plymouth's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Plymouth</>}
        description="Expert drone survey services across Plymouth and Devon. CAA-approved drone operators delivering precision aerial data for naval, marine, and university projects throughout the region."
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Naval & Marine Experience</p>
                    <p className="text-text-secondary text-sm">Devonport & coastal survey expertise</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid Plymouth Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Plymouth"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Plymouth Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Plymouth</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  Plymouth and Devon. From naval facilities at Devonport to coastal research
                  sites, we have the expertise and clearances to operate in demanding environments.
                </p>
                <p>
                  Our team of CAA-certified drone pilots and qualified surveyors have completed
                  numerous projects across the region, from the historic Barbican to
                  major marine research installations.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-gold mb-1">Devon</p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Plymouth Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Plymouth
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Plymouth projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Plymouth Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Plymouth project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Plymouth project?</p>
            <button
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Ready to Discuss Your Plymouth Project?
            </h3>
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Plymouth drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Plymouth projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across Plymouth
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across all areas of Plymouth
              and the surrounding Devon and Cornwall regions. No location is too challenging.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {plymouthAreas.map((area) => (
              <div
                key={area.region}
                className="bg-background-alt border border-border rounded-xl p-6 hover:border-gold hover:shadow-lg transition-all duration-300"
              >
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['HMNB Devonport', 'The Barbican', 'Sutton Harbour', 'Drake Circus', 'Derriford Business Park', 'Plymouth Science Park', 'Millbay', 'South Yard'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Plymouth drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Plymouth drone operations.
                </p>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Plymouth project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Plymouth.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Plymouth Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Plymouth drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Naval and marine sector expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Plymouth */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Skykam Drone Inspections Plymouth',
            alternateName: 'Skykam LTD',
            description: 'Professional drone survey services in Plymouth and Devon. CAA-approved drone operators delivering precision aerial data for naval, marine, and university projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://skykam.co.uk/areas/plymouth',
            areaServed: [
              { '@type': 'City', name: 'Plymouth' },
              { '@type': 'AdministrativeArea', name: 'Devon' },
              { '@type': 'Place', name: 'HMNB Devonport' },
              { '@type': 'Place', name: 'Saltash' },
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Plymouth Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Plymouth',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Plymouth',
                  },
                },
                {
                  '@type': 'Offer',
