...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Dundee.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Dundee construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Dundee and Tayside.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Dundee building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Dundee.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Dundee and surrounding areas.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Dundee project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains any required airspace permissions, and prepares all necessary equipment. We handle all CAA regulations and site-specific risk assessments for your project.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-approved drone pilots capture high-quality aerial data across Dundee using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Gaming & Digital', Icon: Gamepad2, description: 'Rockstar North, indie studios, V&A Dundee tech hub' },
  { name: 'Biotech & Life Sciences', Icon: FlaskConical, description: 'University research, pharmaceutical, medical technology' },
  { name: 'Education & Research', Icon: GraduationCap, description: 'University of Dundee, Abertay, research institutions' },
  { name: 'Construction', Icon: HardHat, description: 'Waterfront regeneration, city centre developments' },
  { name: 'Commercial Property', Icon: Building2, description: 'Office buildings, retail spaces, property surveys' },
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations in Dundee controlled airspace.',
  },
  {
    name: 'Fully Insured',
...
const dundeeAreas = [
  {
    region: 'City Centre',
    areas: ['City Quay', 'Waterfront', 'Overgate', 'Nethergate', 'Commercial Street'],
  },
  {
    region: 'North Dundee',
    areas: ['Lochee', 'Charleston', 'Menzieshill', 'Kirkton', 'Ardler'],
  },
  {
    region: 'East Dundee',
    areas: ['Broughty Ferry', 'Barnhill', 'Monifieth', 'Balgillo', 'Douglas'],
  },
  {
    region: 'West Dundee',
    areas: ['Invergowrie', 'Ninewells', 'Perth Road', 'Blackness', 'Sinderins'],
  },
  {
    region: 'Tayside Region',
    areas: ['Perth', 'Arbroath', 'Forfar', 'Montrose', 'Carnoustie'],
  },
];
...
const faqs = [
  {
    ...
    answer: 'Our headquarters is based right here in Dundee! This means we can offer the fastest response times for local projects, often same-day mobilisation. Being based in the city gives us deep local knowledge and strong relationships with local authorities and businesses.',
  },
  {
    question: 'How much does a drone survey cost in Dundee?',
    answer: 'Being based in Dundee means no travel costs for local projects. Small site surveys start from around £450, while larger commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Dundee project.',
  },
  {
    question: 'How quickly can you respond to Dundee projects?',
    answer: 'As our headquarters is in Dundee, we can often mobilise for local projects the same day. For urgent requirements, we\'re just minutes away. This local presence means faster turnaround times and more flexible scheduling for all Dundee projects.',
  },
  {
    question: 'Do you work with the local universities?',
    answer: 'Yes, we have strong relationships with both the University of Dundee and Abertay University. We\'ve completed numerous projects supporting research, campus development, and educational initiatives. Our local presence makes collaboration easy and efficient.',
  },
  {
    question: 'What Dundee projects have you completed?',
    answer: 'We\'ve completed numerous projects across Dundee including surveys for the V&A Dundee waterfront area, construction monitoring for city centre regeneration projects, roof inspections for commercial properties, and topographic surveys for planning applications throughout Tayside.',
  },
  {
    question: 'How accurate are your Dundee drone surveys?',
    answer: 'Our Dundee drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'What areas around Dundee do you cover?',
    answer: 'From our Dundee headquarters, we cover all of Tayside including Perth, Angus, and Fife. We also serve Edinburgh, Glasgow, Aberdeen, and the rest of Scotland. Our central location makes us ideally positioned to reach any Scottish location quickly.',
  },
  {
    question: 'What deliverables do you provide for Dundee projects?',
...
export default function DundeePage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Our Headquarters - Scotland's Innovation City"
        title={<>Professional <span className="text-gold">Drone Survey</span> Dundee</>}
        description="Expert drone survey services from our Dundee headquarters. CAA-approved drone operators delivering precision aerial data for gaming, biotech, and construction projects. Same-day response available from our local base."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-text-primary text-lg mb-8 leading-relaxed font-medium">
                Being <span className="text-teal">Dundee-based</span> means we understand the local
                landscape, have strong relationships with local businesses and authorities, and can
                offer <span className="text-teal">same-day mobilisation</span> for urgent projects.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Dundee Headquarters</p>
                    <p className="text-text-secondary text-sm">Same-day response available</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Immediate Response</p>
                    <p className="text-text-secondary text-sm">Minutes away - no travel delays</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 text-center md:text-left">
            <div className="flex items-center gap-3">
              ...
              <span className="text-teal-dark font-bold text-xl">Dundee is Our Home Base</span>
            </div>
            <div className="h-px md:h-8 w-full md:w-px bg-teal-dark/30" />
            <p className="text-teal-dark/80">
              <strong>No travel costs</strong> for Dundee projects • <strong>Same-day mobilisation</strong> available • <strong>Local expertise</strong> you can trust
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Dundee"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-teal font-bold text-lg">HQ</p>
                      <p className="text-text-secondary text-sm">Dundee Based</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Proudly <span className="text-wipe-red">Dundee</span> Based
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  Skykam Drone Inspections is proudly headquartered in Dundee, Scotland's city
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-gold mb-1">HQ</p>
                  <p className="text-text-secondary text-sm">Based in Dundee</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold text-gold mb-1">Same</p>
                  <p className="text-text-secondary text-sm">Day Response</p>
                </div>
              </div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Dundee Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Dundee
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Dundee projects,
              delivered with precision and professionalism from our local headquarters.
            </p>
          </div>
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Dundee Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Dundee project.
            </p>
          </div>
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Ready to Discuss Your Dundee Project?
            </h3>
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Dundee drone survey.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a href="tel:+441382720911" className="flex items-center gap-2 text-gold hover:text-gold-light transition-colors font-semibold">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Dundee projects.
            </p>
          </div>
      ...
      {/* Dundee Coverage Section */}
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Dundee & Tayside Coverage
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across Dundee
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              From our Dundee headquarters, we provide professional drone survey services
              across Tayside and beyond. No location is too challenging.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {dundeeAreas.map((area) => (
              <div
                key={area.region}
                className="bg-background-alt border border-border rounded-xl p-6 hover:border-gold hover:shadow-lg transition-all duration-300"
              >
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            <h4 className="text-white font-bold text-xl mb-4">Key Business & Innovation Areas</h4>
            <div className="flex flex-wrap justify-center gap-4">
              {['V&A Dundee', 'City Quay', 'Waterfront', 'Technopole', 'Dundee One', 'Ninewells', 'Discovery Point', 'Broughty Ferry'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Dundee drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Dundee drone operations.
                </p>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Dundee project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Dundee.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Dundee Drone Survey Quote
              </h3>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Response within 1 hour (local advantage)</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-gold/20 rounded-full flex items-center justify-center">
                    <svg className="w-5 h-5 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Schema Markup for Local Business - Dundee (HQ) */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'Professional drone survey services headquartered in Dundee, Scotland. CAA-approved drone operators delivering precision aerial data for gaming, biotech, construction, and property projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            telephone: '+441382720911',
            email: 'jamie@skykam.co.uk',
            url: 'https://skykam.co.uk/areas/dundee',
            areaServed: [
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Dundee Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Dundee',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Dundee',
                  },
                },
                {
                  '@type': 'Offer',
