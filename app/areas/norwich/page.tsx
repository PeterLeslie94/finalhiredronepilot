...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Norwich.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Norwich construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Norfolk.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Norwich building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Norwich.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Norwich and surrounding areas.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Norwich project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all equipment. We handle all CAA regulations and site-specific risk assessments for Norwich locations.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Norwich using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Agriculture', Icon: Wheat, description: 'Crop monitoring, field mapping, drainage surveys, farm management' },
  { name: 'Insurance', Icon: Shield, description: 'Aviva, claims assessment, risk surveys, property inspections' },
  { name: 'Heritage & Conservation', Icon: Landmark, description: 'Norwich Cathedral, historic buildings, conservation areas' },
  { name: 'Commercial Property', Icon: Building2, description: 'Office buildings, retail spaces, industrial estates' },
  { name: 'Property Development', Icon: HomeIcon, description: 'New developments, residential projects, planning applications' },
  { name: 'Coastal & Environmental', Icon: Waves, description: 'Norfolk Broads, coastal erosion, environmental monitoring' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Norfolk.',
  },
  {
    name: 'Fully Insured',
...
const norwichAreas = [
  {
    region: 'Norwich City',
    boroughs: ['City Centre', 'Thorpe Hamlet', 'Eaton', 'Bowthorpe', 'Catton'],
  },
  {
    region: 'South Norfolk',
    boroughs: ['Wymondham', 'Diss', 'Long Stratton', 'Harleston', 'Loddon'],
  },
  {
    region: 'Broadland',
    boroughs: ['Wroxham', 'Aylsham', 'Reepham', 'Hoveton', 'Blofield'],
  },
  {
    region: 'North Norfolk',
    boroughs: ['Cromer', 'Sheringham', 'Holt', 'Wells-next-the-Sea', 'Fakenham'],
  },
  {
    region: 'Great Yarmouth',
    boroughs: ['Great Yarmouth', 'Gorleston', 'Caister-on-Sea', 'Hemsby'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near Norwich Airport?',
    answer: 'Yes, we hold the necessary CAA permissions and can obtain clearances for flights near Norwich Airport and other controlled airspace in Norfolk. We handle all the complex airspace permissions so you don\'t have to, ensuring full compliance with aviation regulations.',
  },
  {
    question: 'How much does a drone survey cost in Norwich?',
    answer: 'Norwich drone survey costs vary based on site size, complexity, and deliverables needed. As a guide, small site surveys start from around £450, while larger agricultural or commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Norwich project.',
  },
  {
    question: 'Do you provide agricultural drone surveys in Norfolk?',
    answer: 'Yes, we specialise in agricultural drone surveys across Norfolk\'s extensive farming areas. Services include crop health monitoring using NDVI imaging, drainage surveys, field boundary mapping, and volumetric analysis of stored crops. Our multispectral sensors provide detailed insights for precision farming.',
  },
  {
    question: 'Can you survey heritage buildings in Norwich?',
    answer: 'Absolutely. We have extensive experience surveying historic and listed buildings including Norwich Cathedral and other heritage sites. Our drones can capture detailed imagery and 3D data for conservation, restoration, and planning purposes without the need for scaffolding.',
  },
  {
    question: 'How quickly can you respond to Norwich projects?',
    answer: 'We can typically mobilise for Norwich projects within 24-48 hours for urgent requirements. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place and optimal survey conditions.',
  },
  {
    question: 'Do you cover the Norfolk Broads?',
    answer: 'Yes, we provide drone surveys across the Norfolk Broads, including environmental monitoring, flood risk assessment, and property surveys. We have experience working in sensitive environmental areas and understand the specific requirements for surveys in the Broads National Park.',
  },
  {
    question: 'What deliverables do you provide for Norwich projects?',
  ...
  {
    question: 'How accurate are your Norwich drone surveys?',
    answer: 'Our Norwich drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
];
...
export default function NorwichPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Norwich's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Norwich</>}
        description="Expert drone survey services across Norwich and Norfolk. CAA-approved drone operators delivering precision aerial data for agriculture, insurance, heritage, and construction projects."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Norwich Drone Survey Experts
              </p>
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Professional Kit. <span className="text-wipe-red">Norfolk Expertise.</span> <span className="underline-sweep">Agricultural & Heritage Specialists.</span>
              </h2>
              <p className="text-text-secondary text-lg mb-6 leading-relaxed">
                Norfolk combines vast agricultural landscapes with historic heritage sites
                and coastal environments. You need drone survey operators who understand
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Agricultural Expertise</p>
                    <p className="text-text-secondary text-sm">Crop monitoring & farm surveys</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid Norwich Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Norwich"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-teal font-bold text-lg">75+</p>
                      <p className="text-text-secondary text-sm">Norwich Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Norwich</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  Norwich and Norfolk. From agricultural land to historic city buildings,
                  we have the expertise to handle any project.
                </p>
                <p>
                  Our team of CAA-certified drone pilots and qualified surveyors have completed
                  numerous projects across the region, from Norwich city centre to the
                  Norfolk Broads and coastal areas.
                </p>
              </div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Norwich Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Norwich
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Norwich projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Norwich Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Norwich project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Norwich project?</p>
            <button
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            ...
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Norwich drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Norwich projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across Norfolk
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across Norwich city
              and all Norfolk districts. No location is too challenging.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {norwichAreas.map((area) => (
              <div
                key={area.region}
                className="bg-background-alt border border-border rounded-xl p-6 hover:border-gold hover:shadow-lg transition-all duration-300"
              >
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            <h4 className="text-white font-bold text-xl mb-4">Key Business & Agricultural Areas</h4>
            <div className="flex flex-wrap justify-center gap-4">
              {['Norwich Research Park', 'Broadland Business Park', 'Norfolk Broads', 'Breckland', 'King\'s Lynn', 'Thetford Forest', 'North Norfolk Coast', 'Great Yarmouth Port'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Norwich drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Norwich drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Norfolk with all necessary permissions.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Norwich project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Norwich.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Norwich Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Norwich drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Norfolk agricultural expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Norwich */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Skykam Drone Inspections Norwich',
            alternateName: 'Skykam LTD',
            description: 'Professional drone survey services in Norwich and Norfolk. CAA-approved drone operators delivering precision aerial data for agriculture, insurance, heritage, and construction projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://skykam.co.uk/areas/norwich',
            areaServed: [
              { '@type': 'City', name: 'Norwich' },
              { '@type': 'AdministrativeArea', name: 'Norfolk' },
              { '@type': 'AdministrativeArea', name: 'South Norfolk' },
              { '@type': 'AdministrativeArea', name: 'Broadland' },
              { '@type': 'AdministrativeArea', name: 'North Norfolk' },
              { '@type': 'AdministrativeArea', name: 'Great Yarmouth' },
            ],
            geo: {
              '@type': 'GeoCoordinates',
              latitude: 52.6309,
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Norwich Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Norwich',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Agricultural Drone Survey Norfolk',
                  },
                },
                {
                  '@type': 'Offer',
