...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Sheffield.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Sheffield industrial sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across South Yorkshire.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Sheffield building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Sheffield.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Sheffield and South Yorkshire.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Sheffield project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all equipment. We handle all CAA regulations and site-specific risk assessments for Sheffield operations.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Sheffield using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Steel & Metals', Icon: Factory, description: 'Forgemasters, special steels, metalworking facilities' },
  { name: 'Manufacturing', Icon: HardHat, description: 'Advanced manufacturing, precision engineering' },
  { name: 'University & Research', Icon: GraduationCap, description: 'University of Sheffield, Sheffield Hallam, AMRC' },
  { name: 'Construction', Icon: Building2, description: 'City centre regeneration, Heart of the City' },
  { name: 'Energy & Utilities', Icon: Zap, description: 'Yorkshire Water, Northern Powergrid, infrastructure' },
  { name: 'Transport', Icon: Train, description: 'Supertram, rail infrastructure, HS2 preparations' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across South Yorkshire.',
  },
  {
    name: 'Fully Insured',
...
const sheffieldAreas = [
  {
    region: 'Sheffield City Centre',
    boroughs: ['City Centre', 'Kelham Island', 'The Moor', 'Devonshire Quarter', 'Cultural Industries Quarter'],
  },
  {
    region: 'North Sheffield',
    boroughs: ['Hillsborough', 'Chapeltown', 'Ecclesfield', 'Stocksbridge', 'Oughtibridge'],
  },
  {
    region: 'South Sheffield',
    boroughs: ['Gleadless', 'Norton', 'Woodseats', 'Beauchief', 'Dore'],
  },
  {
    region: 'East Sheffield',
    boroughs: ['Rotherham', 'Attercliffe', 'Darnall', 'Handsworth', 'Woodhouse'],
  },
  {
    region: 'West Sheffield',
    boroughs: ['Crookes', 'Walkley', 'Fulwood', 'Ranmoor', 'Stannington'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near Sheffield city centre?',
    answer: 'Yes, we hold the necessary CAA permissions for drone operations throughout Sheffield, including the city centre. We coordinate with relevant authorities and handle all airspace permissions so you don\'t have to worry about compliance.',
  },
  {
    question: 'How much does a drone survey cost in Sheffield?',
    answer: 'Sheffield drone survey costs vary based on site size, complexity, and deliverables needed. As a guide, small site surveys start from around £500, while larger industrial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Sheffield project.',
  },
  {
    question: 'How quickly can you respond to Sheffield projects?',
    answer: 'We can typically mobilise for Sheffield projects within 24-48 hours for urgent requirements. Our experienced team is well-versed in obtaining rapid airspace permissions when needed. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place.',
  },
  {
    question: 'Do you cover all of South Yorkshire?',
    answer: 'Yes, we provide comprehensive drone survey services across all of South Yorkshire including Sheffield, Rotherham, Barnsley, Doncaster, and surrounding areas. We also cover the Peak District for rural and agricultural surveys. No location is too challenging for our experienced team.',
  },
  {
    question: 'What Sheffield projects have you completed?',
    answer: 'We\'ve completed numerous projects across South Yorkshire including industrial site surveys for steel and manufacturing facilities, university campus mapping, construction monitoring at Heart of the City, and topographic surveys for planning applications. Our experience covers everything from the AMRC to historic Kelham Island.',
  },
  {
    question: 'How accurate are your Sheffield drone surveys?',
    answer: 'Our Sheffield drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'Can you survey industrial and manufacturing sites?',
    answer: 'Yes, we have extensive experience surveying industrial facilities including steel works, manufacturing plants, and heavy industrial sites. We understand the unique requirements of industrial environments and work closely with site managers to ensure safe and efficient operations.',
  },
  {
    question: 'What deliverables do you provide for Sheffield projects?',
...
export default function SheffieldPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Sheffield's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Sheffield</>}
        description="Expert drone survey services across South Yorkshire. CAA-approved drone operators delivering precision aerial data for steel, manufacturing, university, and construction projects throughout the region."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Sheffield Drone Survey Experts
              </p>
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Professional Kit. <span className="text-wipe-red">Sheffield Expertise.</span> <span className="underline-sweep">Industrial Projects Handled.</span>
              </h2>
              <p className="text-text-secondary text-lg mb-6 leading-relaxed">
                Sheffield is the Steel City - a hub of advanced manufacturing, world-class
                universities, and major regeneration. From industrial facilities to research
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Sheffield Airspace Experts</p>
                    <p className="text-text-secondary text-sm">Full CAA compliance & permissions</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid Sheffield Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Sheffield"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Sheffield Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Sheffield</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  all of South Yorkshire. From industrial facilities to university campuses,
                ...
                <p>
                  ...
                  hundreds of projects across the region, from the Advanced Manufacturing
                  Research Centre to Kelham Island, and the Peak District to Doncaster.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-gold mb-1">4</p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Sheffield Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Sheffield
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Sheffield projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Sheffield Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Sheffield project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Sheffield project?</p>
            <button
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            ...
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Sheffield drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Sheffield projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across South Yorkshire
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across all of South Yorkshire
              and the Sheffield City Region. No location is too challenging.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {sheffieldAreas.map((area) => (
              <div
                key={area.region}
                className="bg-background-alt border border-border rounded-xl p-6 hover:border-gold hover:shadow-lg transition-all duration-300"
              >
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Heart of the City', 'Kelham Island', 'AMRC', 'Olympic Legacy Park', 'Sheffield Business Park', 'Meadowhall', 'Don Valley', 'Attercliffe'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Sheffield drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Sheffield drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  South Yorkshire with full compliance.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Sheffield project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Sheffield.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Sheffield Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Sheffield drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Sheffield industrial expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Sheffield */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Skykam Drone Inspections Sheffield',
            alternateName: 'Skykam LTD',
            description: 'Professional drone survey services in Sheffield and South Yorkshire. CAA-approved drone operators delivering precision aerial data for steel, manufacturing, university, and construction projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            areaServed: [
              ...
              { '@type': 'AdministrativeArea', name: 'Rotherham' },
              { '@type': 'AdministrativeArea', name: 'Barnsley' },
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Sheffield Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Sheffield',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Sheffield',
                  },
                },
                {
                  '@type': 'Offer',
