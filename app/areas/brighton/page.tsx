...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Brighton.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Brighton construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Brighton and East Sussex.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Brighton building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Brighton.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Brighton and surrounding areas.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Brighton project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all required equipment. We handle all CAA regulations and site-specific risk assessments for Brighton operations.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Brighton using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Technology', Icon: Cpu, description: 'Silicon Beach tech startups, digital agencies, innovation hubs' },
  { name: 'Creative Industries', Icon: Palette, description: 'Film production, media, design studios, gaming companies' },
  { name: 'Tourism & Leisure', Icon: Palmtree, description: 'Hotels, attractions, seafront developments, event venues' },
  { name: 'Heritage', Icon: Landmark, description: 'Royal Pavilion, Regency architecture, conservation areas' },
  { name: 'Real Estate', Icon: HomeIcon, description: 'Property marketing, roof surveys, boundary mapping' },
  { name: 'Commercial Property', Icon: Building2, description: 'Office developments, retail, mixed-use schemes' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Brighton airspace.',
  },
  {
    name: 'Fully Insured',
...
const brightonAreas = [
  {
    ...
    boroughs: ['City Centre', 'The Lanes', 'North Laine', 'Seafront', 'Kemp Town'],
  },
  {
    region: 'North Brighton',
    boroughs: ['Preston Park', 'Patcham', 'Withdean', 'Hollingbury', 'Hollingdean'],
  },
  {
    region: 'East Brighton',
    boroughs: ['Kemp Town', 'Black Rock', 'Roedean', 'Rottingdean', 'Saltdean'],
  },
  {
    region: 'West Brighton & Hove',
    boroughs: ['Hove', 'Portslade', 'Shoreham', 'Southwick', 'Brunswick'],
  },
  {
    region: 'Surrounding Areas',
    boroughs: ['Lewes', 'Worthing', 'Burgess Hill', 'Haywards Heath', 'Peacehaven'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near Brighton seafront?',
    answer: 'Yes, we hold the necessary CAA permissions and can coordinate flights along the Brighton seafront and coastal areas. We handle all airspace permissions and work around busy tourist periods. Our team is experienced in operating in popular urban environments while ensuring public safety.',
  },
  {
    question: 'How much does a drone survey cost in Brighton?',
    answer: 'Brighton drone survey costs vary based on site size, complexity, and deliverables needed. As a guide, small site surveys start from around £500, while larger commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Brighton project.',
  },
  {
    question: 'How quickly can you respond to Brighton projects?',
    answer: 'We can typically mobilise for Brighton projects within 24-48 hours for urgent requirements. Our team covers the entire East Sussex region and has extensive experience working across Brighton and the South Downs. For planned projects, we recommend 1-2 weeks notice.',
  },
  {
    question: 'Do you work with tech companies in Brighton?',
    answer: 'Yes, we have experience working with technology and creative companies across Brighton\'s Silicon Beach tech cluster. Whether you need surveys for office relocations, campus expansions, or development projects, we understand the fast-paced needs of the tech sector.',
  },
  {
    question: 'What Brighton projects have you completed?',
    answer: 'We\'ve completed numerous projects across Brighton including coastal erosion surveys, building inspections of historic Regency properties, topographic surveys for new developments, and aerial photography for tourism marketing. Our experience covers everything from heritage sites to modern commercial developments.',
  },
  {
    question: 'How accurate are your Brighton drone surveys?',
    answer: 'Our Brighton drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'What areas of Brighton do you cover?',
    answer: 'We provide drone survey services across all of Brighton & Hove and the surrounding East Sussex area including Lewes, Worthing, and the South Downs National Park. From the seafront to the hills, no location is too challenging for our experienced team.',
  },
  {
    question: 'What deliverables do you provide for Brighton projects?',
...
export default function BrightonPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Brighton's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Brighton</>}
        description="Expert drone survey services across Brighton and East Sussex. CAA-approved drone operators delivering precision aerial data for tech, creative, and tourism projects throughout the region."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Brighton Drone Survey Experts
              </p>
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Professional Kit. <span className="text-wipe-red">Coastal Expertise.</span> <span className="underline-sweep">Creative Sector Experience.</span>
              </h2>
              <p className="text-text-secondary text-lg mb-6 leading-relaxed">
                Brighton is the UK's creative and tech hub by the sea, with unique
                survey requirements for historic Regency buildings, seafront developments,
                and innovative tech campuses. You need drone operators who understand these demands.
              </p>
              <p className="text-text-primary text-lg mb-8 leading-relaxed font-medium">
                ...
                <span className="text-teal"> coastal operations expertise</span> and enterprise-grade equipment.
                Every Brighton project we deliver is fully compliant and professional.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Coastal Operations</p>
                    <p className="text-text-secondary text-sm">Seafront & cliff surveys specialist</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid Brighton Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Brighton"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-teal font-bold text-lg">100+</p>
                      <p className="text-text-secondary text-sm">Brighton Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Brighton</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  Brighton & Hove and East Sussex. From historic seafront properties to modern
                  tech campus developments, we have the expertise and permissions to operate anywhere.
                </p>
                <p>
                  Our team of CAA-certified drone pilots and qualified surveyors have completed
                  numerous projects across the region, from the Royal Pavilion to
                  Silicon Beach tech hubs.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-gold mb-1">E.Sx</p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Brighton Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Brighton
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Brighton projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Brighton Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Brighton project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Brighton project?</p>
            <button
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Drone Surveys for Brighton Sectors
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We deliver tailored drone survey solutions across Brighton's key industries.
            </p>
          </div>
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Ready to Discuss Your Brighton Project?
            </h3>
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Brighton drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Brighton projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across Brighton
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across all areas of Brighton & Hove
              and the surrounding East Sussex region. No location is too challenging.
            </p>
          </div>
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Brighton Marina', 'North Laine', 'The Lanes', 'Hove Business Quarter', 'Lewes Road Corridor', 'Preston Park', 'Shoreham Port', 'Gatwick Diamond'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Brighton drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Brighton drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Brighton and the East Sussex region.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Brighton project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Brighton.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Brighton Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Brighton drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Coastal and creative sector expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Brighton */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Skykam Drone Inspections Brighton',
            alternateName: 'Skykam LTD',
            description: 'Professional drone survey services in Brighton and East Sussex. CAA-approved drone operators delivering precision aerial data for tech, creative, and tourism projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://skykam.co.uk/areas/brighton',
            areaServed: [
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Brighton Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Brighton',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Brighton',
                  },
                },
                {
                  '@type': 'Offer',
