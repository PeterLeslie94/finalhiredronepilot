...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Newcastle.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Newcastle construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Tyne and Wear.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Newcastle building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Newcastle.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Newcastle and the North East.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Newcastle project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all equipment. We handle all CAA regulations and site-specific risk assessments for Newcastle operations.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Newcastle using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Energy & Offshore', Icon: Wind, description: 'Offshore wind, North Sea energy, renewables' },
  { name: 'Port & Maritime', Icon: Anchor, description: 'Port of Tyne, shipbuilding, maritime facilities' },
  { name: 'Urban Regeneration', Icon: Building2, description: 'Newcastle Helix, Quayside, Gateshead developments' },
  { name: 'Construction', Icon: HardHat, description: 'City centre developments, infrastructure projects' },
  { name: 'Utilities', Icon: Zap, description: 'Northern Powergrid, Northumbrian Water, infrastructure' },
  { name: 'Transport', Icon: Train, description: 'Metro, rail infrastructure, Newcastle Airport' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across the North East.',
  },
  {
    name: 'Fully Insured',
...
const newcastleAreas = [
  {
    region: 'Newcastle City Centre',
    boroughs: ['Quayside', 'Grainger Town', 'Newcastle Helix', 'Ouseburn', 'Central Station'],
  },
  {
    region: 'North Tyneside',
    boroughs: ['Tynemouth', 'Whitley Bay', 'North Shields', 'Wallsend', 'Longbenton'],
  },
  {
    region: 'Gateshead',
    boroughs: ['Gateshead Quays', 'Team Valley', 'Metrocentre', 'Birtley', 'Blaydon'],
  },
  {
    region: 'South Tyneside',
    boroughs: ['South Shields', 'Jarrow', 'Hebburn', 'Cleadon', 'Boldon'],
  },
  {
    region: 'Wider North East',
    boroughs: ['Sunderland', 'Durham', 'Northumberland', 'Middlesbrough', 'Darlington'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near Newcastle Airport?',
    answer: 'Yes, we hold the necessary CAA permissions and can obtain clearances for flights near Newcastle Airport\'s controlled airspace. We coordinate directly with air traffic control and handle all the complex airspace permissions so you don\'t have to.',
  },
  {
    question: 'How much does a drone survey cost in Newcastle?',
    answer: 'Newcastle drone survey costs vary based on site size, complexity, airspace requirements, and deliverables needed. As a guide, small site surveys start from around £500, while larger commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Newcastle project.',
  },
  {
    question: 'How quickly can you respond to Newcastle projects?',
    answer: 'We can typically mobilise for Newcastle projects within 24-48 hours for urgent requirements. Our experienced team is well-versed in obtaining rapid airspace permissions when needed. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place.',
  },
  {
    question: 'Do you cover all of the North East?',
    answer: 'Yes, we provide comprehensive drone survey services across the entire North East including Newcastle, Gateshead, Sunderland, Durham, Northumberland, and Teesside. We also cover offshore operations in the North Sea. No location is too challenging for our experienced team.',
  },
  {
    question: 'What Newcastle projects have you completed?',
    answer: 'We\'ve completed numerous projects across the North East including offshore energy facility surveys, port and maritime inspections, construction monitoring at major developments like Newcastle Helix, and topographic surveys for planning applications. Our experience covers everything from the Quayside to offshore wind farms.',
  },
  {
    question: 'How accurate are your Newcastle drone surveys?',
    answer: 'Our Newcastle drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'Can you survey offshore energy facilities?',
    answer: 'Yes, we have extensive experience surveying offshore energy infrastructure including wind farms, oil and gas platforms, and subsea cable routes. We work closely with operators and understand the unique requirements of offshore environments, including coordination with vessel movements and safety regulations.',
  },
  {
    question: 'What deliverables do you provide for Newcastle projects?',
...
export default function NewcastlePage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Newcastle's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Newcastle</>}
        description="Expert drone survey services across the North East. CAA-approved drone operators delivering precision aerial data for energy, offshore, regeneration, and construction projects throughout the region."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Newcastle Drone Survey Experts
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Newcastle Airspace Experts</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid Newcastle Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Newcastle"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Newcastle Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Newcastle</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  all of the North East. From offshore energy installations to urban regeneration,
                ...
                <p>
                  ...
                  hundreds of projects across the region, from Newcastle Helix to offshore
                  wind farms, the Quayside to Teesside.
                </p>
              </div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Newcastle Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Newcastle
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Newcastle projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Newcastle Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Newcastle project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Newcastle project?</p>
            <button
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            ...
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Newcastle drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Newcastle projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across the North East
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across all of the North East
              including offshore operations. No location is too challenging.
            </p>
          </div>
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Newcastle Helix', 'Quayside', 'Port of Tyne', 'Team Valley', 'Cobalt Business Park', 'North Sea Energy', 'Nissan Sunderland', 'Offshore Wind Zones'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Newcastle drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Newcastle drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  the North East including airport and offshore coordination.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Newcastle project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Newcastle.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Newcastle Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Newcastle drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Newcastle & offshore expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Newcastle */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Skykam Drone Inspections Newcastle',
            alternateName: 'Skykam LTD',
            description: 'Professional drone survey services in Newcastle and the North East. CAA-approved drone operators delivering precision aerial data for energy, offshore, regeneration, and construction projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            areaServed: [
              ...
              { '@type': 'AdministrativeArea', name: 'Gateshead' },
              { '@type': 'AdministrativeArea', name: 'North Tyneside' },
              { '@type': 'AdministrativeArea', name: 'South Tyneside' },
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Newcastle Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Newcastle',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Newcastle',
                  },
                },
                {
                  '@type': 'Offer',
