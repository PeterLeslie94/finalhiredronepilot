...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Birmingham.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Birmingham construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across the West Midlands.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Birmingham building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Birmingham.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Birmingham and the West Midlands.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Birmingham project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all equipment. We handle all CAA regulations and site-specific risk assessments for your Birmingham project.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Birmingham using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'HS2 & Rail', Icon: Train, description: 'HS2 Curzon Street, rail infrastructure, station developments' },
  { name: 'Construction', Icon: HardHat, description: 'Paradise Birmingham, Smithfield, major regeneration projects' },
  { name: 'Automotive', Icon: Car, description: 'JLR, BMW, automotive manufacturing and supply chain' },
  { name: 'Commercial Property', Icon: Building2, description: 'Office developments, retail spaces, property surveys' },
  { name: 'Manufacturing', Icon: Factory, description: 'Industrial facilities, warehouses, factory inspections' },
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Birmingham and the West Midlands.',
  },
  {
    name: 'Fully Insured',
...
const birminghamAreas = [
  {
    ...
    boroughs: ['City Centre', 'Digbeth', 'Jewellery Quarter', 'Eastside', 'Westside'],
  },
  {
    region: 'North Birmingham',
    boroughs: ['Sutton Coldfield', 'Erdington', 'Perry Barr', 'Handsworth', 'Aston'],
  },
  {
    region: 'South Birmingham',
    boroughs: ['Edgbaston', 'Moseley', 'Kings Heath', 'Hall Green', 'Bournville'],
  },
  {
    region: 'East Birmingham',
    boroughs: ['Solihull', 'Sheldon', 'Yardley', 'Small Heath', 'Bordesley Green'],
  },
  {
    region: 'West Birmingham',
    boroughs: ['Smethwick', 'West Bromwich', 'Dudley', 'Sandwell', 'Oldbury'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near Birmingham Airport?',
    answer: 'Yes, we hold the necessary CAA permissions and can coordinate with Birmingham Airport for flights in controlled airspace. We handle all the complex airspace permissions and safety coordination so you don\'t have to. Our team has extensive experience operating near the airport for HS2 and other major projects.',
  },
  {
    question: 'How much does a drone survey cost in Birmingham?',
    answer: 'Birmingham drone survey costs vary based on site size, complexity, and deliverables needed. As a guide, small site surveys start from around £500, while larger commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Birmingham project.',
  },
  {
    question: 'Do you work on HS2 projects?',
    answer: 'Yes, we have extensive experience working on HS2-related projects across the Birmingham area, including Curzon Street Station and surrounding development sites. Our team understands the specific requirements and compliance standards needed for major infrastructure projects.',
  },
  {
    question: 'How quickly can you respond to Birmingham projects?',
    answer: 'We can typically mobilise for Birmingham projects within 24-48 hours for urgent requirements. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place and optimal flight conditions.',
  },
  {
    question: 'What Birmingham projects have you completed?',
    answer: 'We\'ve completed numerous projects across Birmingham and the West Midlands including construction monitoring at Paradise Birmingham, infrastructure surveys for HS2, industrial inspections at automotive facilities, and topographic surveys for planning applications across the region.',
  },
  {
    question: 'How accurate are your Birmingham drone surveys?',
    answer: 'Our Birmingham drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'What areas of the West Midlands do you cover?',
    answer: 'We provide drone survey services across all of Birmingham and the wider West Midlands, including Solihull, Wolverhampton, Dudley, Walsall, Sandwell, and Coventry. We also cover Warwickshire, Staffordshire, and Worcestershire.',
  },
  {
    question: 'What deliverables do you provide for Birmingham projects?',
...
export default function BirminghamPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Birmingham's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Birmingham</>}
        description="Expert drone survey services across Birmingham and the West Midlands. CAA-approved drone operators delivering precision aerial data for HS2, construction, automotive, and infrastructure projects."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Birmingham Drone Survey Experts
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">HS2 Project Experience</p>
                    <p className="text-text-secondary text-sm">Major infrastructure specialists</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Birmingham"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Birmingham Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Birmingham</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  Birmingham and the West Midlands. From HS2 construction sites to automotive
                  manufacturing facilities, we have the expertise to deliver precision data.
                </p>
                <p>
                  ...
                  industrial sites throughout the Black Country.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  ...
                  <p className="text-text-secondary text-sm">Met Boroughs</p>
                </div>
                <div className="text-center">
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Birmingham Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Birmingham
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Birmingham projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Birmingham Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Birmingham project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Birmingham project?</p>
            <button
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            ...
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Birmingham drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Birmingham projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across the West Midlands
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across Birmingham
              and all seven metropolitan boroughs of the West Midlands.
            </p>
          </div>
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['HS2 Curzon Street', 'Paradise Birmingham', 'Smithfield', 'Digbeth', 'Eastside', 'Arena Central', 'Snow Hill', 'Brindleyplace'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Birmingham drone operations.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Birmingham drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  Fully approved for commercial drone operations across Birmingham
                  and the West Midlands including controlled airspace.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Birmingham project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Birmingham.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Birmingham Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Birmingham drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">HS2 and major project expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Birmingham */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Skykam Drone Inspections Birmingham',
            alternateName: 'Skykam LTD',
            description: 'Professional drone survey services in Birmingham and the West Midlands. CAA-approved drone operators delivering precision aerial data for HS2, construction, automotive, and infrastructure projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://skykam.co.uk/areas/birmingham',
            areaServed: [
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Birmingham Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Birmingham',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Birmingham',
                  },
                },
                {
                  '@type': 'Offer',
