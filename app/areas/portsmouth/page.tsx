...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Portsmouth.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Portsmouth naval and construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Portsmouth and Hampshire.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Portsmouth building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Portsmouth.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Portsmouth and surrounding areas.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Portsmouth project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all required equipment. We handle all CAA regulations and site-specific risk assessments for Portsmouth operations.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Portsmouth using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Naval & Maritime', Icon: Anchor, description: 'Portsmouth Naval Base, HMNB Portsmouth, shipyards' },
  { name: 'Defence', Icon: Shield, description: 'BAE Systems, defence contractors, MOD facilities' },
  { name: 'Port & Logistics', Icon: Ship, description: 'Portsmouth International Port, ferry terminals, cargo' },
  { name: 'Heritage', Icon: Landmark, description: 'Historic Dockyard, Spinnaker Tower, Old Portsmouth' },
  { name: 'Real Estate', Icon: HomeIcon, description: 'Property marketing, roof surveys, boundary mapping' },
  { name: 'Commercial Property', Icon: Building2, description: 'Gunwharf Quays, office developments, retail' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Portsmouth airspace.',
  },
  {
    name: 'Fully Insured',
...
const portsmouthAreas = [
  {
    region: 'Central Portsmouth',
    boroughs: ['City Centre', 'Gunwharf Quays', 'Old Portsmouth', 'Southsea', 'Commercial Road'],
  },
  {
    region: 'North Portsmouth',
    boroughs: ['Cosham', 'Hilsea', 'Copnor', 'North End', 'Stamshaw'],
  },
  {
    region: 'East Portsmouth',
    boroughs: ['Eastney', 'Milton', 'Baffins', 'Fratton', 'Landport'],
  },
  {
    region: 'Gosport & Fareham',
    boroughs: ['Gosport', 'Fareham', 'Lee-on-the-Solent', 'Stubbington', 'Portchester'],
  },
  {
    region: 'Surrounding Areas',
    boroughs: ['Havant', 'Waterlooville', 'Emsworth', 'Hayling Island', 'Chichester'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near Portsmouth Naval Base?',
    answer: 'Yes, we can coordinate drone operations near Portsmouth Naval Base with the appropriate permissions. We have experience working in areas with MOD restrictions and can obtain the necessary clearances through proper channels. All flights are conducted in full compliance with security protocols.',
  },
  {
    question: 'How much does a drone survey cost in Portsmouth?',
    answer: 'Portsmouth drone survey costs vary based on site size, complexity, security requirements, and deliverables needed. As a guide, small site surveys start from around £500, while larger defence or maritime projects are priced based on specific requirements. Contact us for a free, no-obligation quote.',
  },
  {
    question: 'How quickly can you respond to Portsmouth projects?',
    answer: 'We can typically mobilise for Portsmouth projects within 24-48 hours for urgent requirements. However, projects near naval or defence installations may require additional lead time for security clearances. For planned projects, we recommend 2-3 weeks notice for sensitive locations.',
  },
  {
    question: 'Do you work with defence contractors in Portsmouth?',
    answer: 'Yes, we have experience working with defence contractors and understand the security and compliance requirements for sensitive MOD and naval sites. We can provide security-cleared personnel where required and work within strict operational protocols.',
  },
  {
    question: 'What Portsmouth projects have you completed?',
    answer: 'We\'ve completed numerous projects across Portsmouth including heritage surveys at the Historic Dockyard, building inspections for waterfront developments, topographic surveys for residential projects, and infrastructure assessments. Our experience covers both civilian and security-sensitive environments.',
  },
  {
    question: 'How accurate are your Portsmouth drone surveys?',
    answer: 'Our Portsmouth drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'What areas of Portsmouth do you cover?',
    answer: 'We provide drone survey services across all of Portsmouth, Gosport, Fareham, and the wider Hampshire coastal area. From Portsea Island to Hayling Island, and from the naval base to the South Downs, no location is too challenging for our experienced team.',
  },
  {
    question: 'What deliverables do you provide for Portsmouth projects?',
...
export default function PortsmouthPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Portsmouth's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Portsmouth</>}
        description="Expert drone survey services across Portsmouth and Hampshire. CAA-approved drone operators delivering precision aerial data for naval, defence, and heritage projects throughout the region."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Portsmouth Drone Survey Experts
              </p>
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Professional Kit. <span className="text-wipe-red">Naval Heritage.</span> <span className="underline-sweep">Defence Sector Experience.</span>
              </h2>
              <p className="text-text-secondary text-lg mb-6 leading-relaxed">
                Portsmouth is the home of the Royal Navy, with unique survey requirements for
                naval facilities, defence installations, and historic maritime heritage sites.
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Defence Sector Experience</p>
                    <p className="text-text-secondary text-sm">MOD clearance & security protocols</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid Portsmouth Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Portsmouth"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Portsmouth Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Portsmouth</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  Portsmouth and Hampshire. From naval facilities to historic dockyards,
                  we have the expertise and clearances to operate in sensitive environments.
                </p>
                <p>
                  Our team of CAA-certified drone pilots and qualified surveyors have completed
                  numerous projects across the region, from Gunwharf Quays to the Historic
                  Dockyard and beyond.
                </p>
              </div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Portsmouth Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Portsmouth
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Portsmouth projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Portsmouth Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Portsmouth project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Portsmouth project?</p>
            <button
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Ready to Discuss Your Portsmouth Project?
            </h3>
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Portsmouth drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Portsmouth projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across Portsmouth
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across all areas of Portsmouth
              and the surrounding Hampshire region. No location is too challenging.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {portsmouthAreas.map((area) => (
              <div
                key={area.region}
                className="bg-background-alt border border-border rounded-xl p-6 hover:border-gold hover:shadow-lg transition-all duration-300"
              >
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Portsmouth Naval Base', 'Historic Dockyard', 'Gunwharf Quays', 'Portsmouth International Port', 'Lakeside Business Park', 'Cosham', 'Fareham Business Park', 'Gosport Waterfront'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Portsmouth drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Portsmouth drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Portsmouth and the Hampshire region.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Portsmouth project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Portsmouth.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Portsmouth Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Portsmouth drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Naval and defence sector expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Portsmouth */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Skykam Drone Inspections Portsmouth',
            alternateName: 'Skykam LTD',
            description: 'Professional drone survey services in Portsmouth and Hampshire. CAA-approved drone operators delivering precision aerial data for naval, defence, and heritage projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://skykam.co.uk/areas/portsmouth',
            areaServed: [
              { '@type': 'City', name: 'Portsmouth' },
              { '@type': 'City', name: 'Gosport' },
              { '@type': 'AdministrativeArea', name: 'Hampshire' },
              { '@type': 'Place', name: 'Fareham' },
              { '@type': 'Place', name: 'Havant' },
              { '@type': 'Place', name: 'Portsmouth Naval Base' },
            ],
            geo: {
              '@type': 'GeoCoordinates',
              latitude: 50.8198,
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Portsmouth Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Portsmouth',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Portsmouth',
                  },
                },
                {
                  '@type': 'Offer',
