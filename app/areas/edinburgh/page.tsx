...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Edinburgh.',
  ...
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Edinburgh and the Lothians.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Edinburgh building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Edinburgh.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Edinburgh and surrounding areas.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Edinburgh project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains Edinburgh airspace permissions, and prepares all necessary equipment. We handle all CAA regulations and site-specific risk assessments for your project.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-approved drone pilots capture high-quality aerial data across Edinburgh using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Financial Services', Icon: Briefcase, description: 'Charlotte Square, George Street, financial district surveys' },
  { name: 'Festivals & Events', Icon: Calendar, description: 'Edinburgh Festival, Royal Mile, event venue mapping' },
  { name: 'Heritage & Conservation', Icon: Landmark, description: 'UNESCO World Heritage Site, Old Town, listed buildings' },
  { name: 'Construction', Icon: HardHat, description: 'St James Quarter, Haymarket, major development projects' },
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations in Edinburgh controlled airspace.',
  },
  {
    name: 'Fully Insured',
...
const edinburghAreas = [
  {
    region: 'City Centre',
    areas: ['Old Town', 'New Town', 'Grassmarket', 'Royal Mile', 'Princes Street'],
  },
  {
    region: 'North Edinburgh',
    areas: ['Leith', 'Newhaven', 'Trinity', 'Granton', 'Stockbridge'],
  },
  {
    region: 'South Edinburgh',
    areas: ['Morningside', 'Marchmont', 'Bruntsfield', 'Newington', 'Liberton'],
  },
  {
    region: 'East Edinburgh',
    areas: ['Portobello', 'Musselburgh', 'Craigmillar', 'Duddingston', 'Joppa'],
  },
  {
    region: 'West Edinburgh',
    areas: ['Corstorphine', 'Murrayfield', 'Gorgie', 'Sighthill', 'Edinburgh Park'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones in Edinburgh city centre?',
    answer: 'Yes, we hold the necessary CAA permissions and can obtain clearances for flights in Edinburgh\'s airspace, including near Edinburgh Airport. We handle all the complex airspace permissions, including flights over the UNESCO World Heritage Site with appropriate approvals.',
  },
  {
    question: 'How much does a drone survey cost in Edinburgh?',
    answer: 'Edinburgh drone survey costs vary based on site size, complexity, airspace requirements, and deliverables needed. As a guide, small site surveys start from around £500, while larger commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Edinburgh project.',
  },
  {
    question: 'How quickly can you respond to Edinburgh projects?',
    answer: 'Being based in nearby Dundee (just 60 miles away), we can typically mobilise for Edinburgh projects within 24 hours. Our Scottish headquarters means fast response times and local expertise for all Edinburgh projects.',
  },
  {
    question: 'Do you have experience with heritage buildings in Edinburgh?',
    answer: 'Yes, our team has extensive experience surveying listed buildings and properties within Edinburgh\'s UNESCO World Heritage Site. We understand the sensitivities involved and work closely with Historic Environment Scotland when required.',
  },
  {
    question: 'What Edinburgh projects have you completed?',
    answer: 'We\'ve completed numerous projects across Edinburgh including construction monitoring at St James Quarter, heritage surveys in the Old Town, roof inspections for commercial properties, and topographic surveys for planning applications throughout the Lothians.',
  },
  {
    question: 'How accurate are your Edinburgh drone surveys?',
    answer: 'Our Edinburgh drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'What areas of Edinburgh do you cover?',
    answer: 'We provide drone survey services across all of Edinburgh and the Lothians, including the city centre, Leith, Portobello, Corstorphine, and surrounding areas. We also cover East Lothian, West Lothian, and Midlothian.',
  },
  {
    question: 'What deliverables do you provide for Edinburgh projects?',
...
export default function EdinburghPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Scotland's Capital Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Edinburgh</>}
        description="Expert drone survey services across Edinburgh and the Lothians. CAA-approved drone operators delivering precision aerial data for construction, heritage, and property projects throughout Scotland's capital. Based in nearby Dundee for rapid response."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Edinburgh Drone Survey Experts
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Heritage Specialists</p>
                    <p className="text-text-secondary text-sm">UNESCO World Heritage Site experience</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-text-secondary text-sm">60 miles from our HQ - same day available</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Edinburgh"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Edinburgh Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Edinburgh</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  all of Edinburgh and the Lothians. From historic Old Town properties to
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-gold mb-1">60mi</p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Edinburgh Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Edinburgh
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Edinburgh projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Edinburgh Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Edinburgh project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Edinburgh project?</p>
            <button
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Ready to Discuss Your Edinburgh Project?
            </h3>
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Edinburgh drone survey.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a href="tel:+441onal382720911" className="flex items-center gap-2 text-gold hover:text-gold-light transition-colors font-semibold">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Edinburgh projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across Edinburgh
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across all of Edinburgh
              and the Lothians. No location is too challenging.
            </p>
          </div>
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Charlotte Square', 'George Street', 'St James Quarter', 'Edinburgh Park', 'Quartermile', 'Haymarket', 'Leith', 'South Gyle'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Edinburgh drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Edinburgh drone operations.
                </p>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Edinburgh project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Edinburgh.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Edinburgh Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Edinburgh drone survey requirements? Complete the form
      ...
      {/* Schema Markup for Local Business - Edinburgh */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Skykam Drone Inspections Edinburgh',
            alternateName: 'Skykam LTD',
            description: 'Professional drone survey services in Edinburgh and the Lothians. CAA-approved drone operators delivering precision aerial data for construction, heritage, and property projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://skykam.co.uk/areas/edinburgh',
            areaServed: [
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Edinburgh Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Edinburgh',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Heritage Survey Edinburgh',
                  },
                },
                {
                  '@type': 'Offer',
