...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Milton Keynes.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Milton Keynes construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Milton Keynes and Buckinghamshire.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Milton Keynes building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Milton Keynes.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Milton Keynes and surrounding areas.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Milton Keynes project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all equipment. We handle all CAA regulations and site-specific risk assessments for Milton Keynes locations.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Milton Keynes using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Logistics & Distribution', Icon: Truck, description: 'Amazon, John Lewis, Magna Park distribution centres' },
  { name: 'Technology', Icon: Cpu, description: 'Tech startups, innovation centres, Santander UK' },
  { name: 'Warehousing', Icon: Warehouse, description: 'Distribution hubs, industrial estates, storage facilities' },
  { name: 'Construction', Icon: HardHat, description: 'New developments, infrastructure, expansion projects' },
  { name: 'Commercial Property', Icon: Building2, description: 'Business parks, retail centres, office developments' },
  { name: 'Residential Development', Icon: HomeIcon, description: 'Housing estates, urban expansion, new town development' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Buckinghamshire.',
  },
  {
    name: 'Fully Insured',
...
const miltonKeynesAreas = [
  {
    region: 'Central Milton Keynes',
    boroughs: ['Central MK', 'Campbell Park', 'Fishermead', 'Oldbrook', 'Woolstone'],
  },
  {
    region: 'North Milton Keynes',
    boroughs: ['Wolverton', 'Stony Stratford', 'Newport Pagnell', 'Olney', 'Bradwell'],
  },
  {
    region: 'South Milton Keynes',
    boroughs: ['Bletchley', 'Fenny Stratford', 'Water Eaton', 'Newton Longville'],
  },
  {
    region: 'West Milton Keynes',
    boroughs: ['Westcroft', 'Furzton', 'Shenley', 'Tattenhoe', 'Kingsmead'],
  },
  {
    region: 'Surrounding Areas',
    boroughs: ['Buckingham', 'Woburn Sands', 'Leighton Buzzard', 'Aylesbury'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones over Milton Keynes distribution centres?',
    answer: 'Yes, we regularly conduct drone surveys over large logistics and distribution facilities in Milton Keynes. We coordinate with site management, handle all CAA requirements, and ensure operations don\'t interfere with warehouse activities. Our experience includes surveys at Magna Park, Amazon facilities, and other major distribution hubs.',
  },
  {
    question: 'How much does a drone survey cost in Milton Keynes?',
    answer: 'Milton Keynes drone survey costs vary based on site size, complexity, and deliverables needed. As a guide, small site surveys start from around £500, while larger logistics facilities or development sites are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Milton Keynes project.',
  },
  {
    question: 'Do you work with logistics and warehouse operators?',
    answer: 'Yes, we have extensive experience working with major logistics operators across Milton Keynes. We understand the operational requirements of busy distribution centres and can schedule surveys to minimise disruption. Our services include roof inspections, site surveys, and progress monitoring for new builds.',
  },
  {
    question: 'Can you survey new development sites in Milton Keynes?',
    answer: 'Absolutely. Milton Keynes continues to expand rapidly, and we regularly survey new development sites across the area. From initial topographic surveys to construction progress monitoring, we provide comprehensive aerial data throughout the development lifecycle.',
  },
  {
    question: 'How quickly can you respond to Milton Keynes projects?',
    answer: 'We can typically mobilise for Milton Keynes projects within 24-48 hours for urgent requirements. Milton Keynes\' central location makes it easily accessible. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place.',
  },
  {
    question: 'What deliverables do you provide for Milton Keynes projects?',
  ...
  {
    question: 'Do you cover the wider Buckinghamshire area?',
    answer: 'Yes, we provide comprehensive coverage across Buckinghamshire and surrounding areas including Aylesbury, Buckingham, Leighton Buzzard, and into Bedfordshire and Northamptonshire. Milton Keynes\' excellent transport links make it an ideal base for regional projects.',
  },
  {
    question: 'How accurate are your Milton Keynes drone surveys?',
    answer: 'Our Milton Keynes drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
];
...
export default function MiltonKeynesPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Milton Keynes' Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Milton Keynes</>}
        description="Expert drone survey services across Milton Keynes and Buckinghamshire. CAA-approved drone operators delivering precision aerial data for logistics, new developments, and construction projects."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Milton Keynes Drone Survey Experts
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Logistics Expertise</p>
                    <p className="text-text-secondary text-sm">Distribution centres & warehouses</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid MK Response</p>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Milton Keynes"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">MK Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Milton Keynes Coverage
              </p>
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Milton Keynes</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  Milton Keynes and Buckinghamshire. From logistics hubs to new housing
                  developments, we have the expertise to handle any project.
                </p>
                <p>
                  Our team of CAA-certified drone pilots and qualified surveyors have completed
                  numerous projects across MK, from distribution centre roof surveys to
                  development site progress monitoring.
                </p>
              </div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Milton Keynes Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Milton Keynes
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Milton Keynes projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Milton Keynes Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Milton Keynes project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Milton Keynes project?</p>
            <button
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Ready to Discuss Your Milton Keynes Project?
            </h3>
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Milton Keynes drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Milton Keynes projects.
            </p>
          </div>
      ...
      {/* Milton Keynes Coverage Section */}
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across MK & Buckinghamshire
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across Milton Keynes
              and the wider Buckinghamshire area. No location is too challenging.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {miltonKeynesAreas.map((area) => (
              <div
                key={area.region}
                className="bg-background-alt border border-border rounded-xl p-6 hover:border-gold hover:shadow-lg transition-all duration-300"
              >
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            <h4 className="text-white font-bold text-xl mb-4">Key Industrial & Business Parks</h4>
            <div className="flex flex-wrap justify-center gap-4">
              {['Magna Park', 'Milton Keynes Business Centre', 'Knowlhill', 'Denbigh', 'Kiln Farm', 'Tongwell', 'Linford Wood', 'Northfield'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Milton Keynes drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Milton Keynes drone operations.
                </p>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Milton Keynes project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Milton Keynes.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Milton Keynes Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Milton Keynes drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">MK logistics expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Milton Keynes */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Skykam Drone Inspections Milton Keynes',
            alternateName: 'Skykam LTD',
            description: 'Professional drone survey services in Milton Keynes and Buckinghamshire. CAA-approved drone operators delivering precision aerial data for logistics, new developments, and construction projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://skykam.co.uk/areas/milton-keynes',
            areaServed: [
              { '@type': 'City', name: 'Milton Keynes' },
              { '@type': 'AdministrativeArea', name: 'Buckinghamshire' },
              { '@type': 'AdministrativeArea', name: 'Central Bedfordshire' },
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Milton Keynes Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Milton Keynes',
                  },
                },
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Aerial Survey Milton Keynes',
                  },
                },
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Logistics Facility Survey',
                  },
                },
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'LiDAR Mapping Milton Keynes',
                  },
                },
              ],
            },
