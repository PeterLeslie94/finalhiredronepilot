...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Liverpool.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Liverpool construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Merseyside.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Liverpool building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Liverpool.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Liverpool and Merseyside.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Liverpool project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all equipment. We handle all CAA regulations and site-specific risk assessments for Liverpool operations.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Liverpool using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Port & Maritime', Icon: Anchor, description: 'Port of Liverpool, Seaforth, Birkenhead docks' },
  { name: 'Urban Regeneration', Icon: Building2, description: 'Liverpool Waters, Baltic Triangle, Ten Streets' },
  { name: 'Construction', Icon: HardHat, description: 'City centre developments, waterfront projects' },
  { name: 'Energy & Utilities', Icon: Zap, description: 'United Utilities, offshore wind, infrastructure' },
  { name: 'Real Estate', Icon: HomeIcon, description: 'Property marketing, roof surveys, boundary mapping' },
  { name: 'Transport', Icon: Train, description: 'Merseyrail, highways, Liverpool John Lennon Airport' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Merseyside.',
  },
  {
    name: 'Fully Insured',
...
const liverpoolAreas = [
  {
    region: 'Liverpool City Centre',
    boroughs: ['Waterfront', 'Baltic Triangle', 'Ropewalks', 'Commercial District', 'Knowledge Quarter'],
  },
  {
    region: 'North Liverpool',
    boroughs: ['Bootle', 'Crosby', 'Kirkdale', 'Everton', 'Walton'],
  },
  {
    region: 'South Liverpool',
    boroughs: ['Toxteth', 'Aigburth', 'Garston', 'Speke', 'Woolton'],
  },
  {
    region: 'Wirral',
    boroughs: ['Birkenhead', 'Wallasey', 'Bebington', 'Heswall', 'West Kirby'],
  },
  {
    region: 'Wider Merseyside',
    boroughs: ['Knowsley', 'St Helens', 'Sefton', 'Halton', 'Warrington'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near Liverpool John Lennon Airport?',
    answer: 'Yes, we hold the necessary CAA permissions and can obtain clearances for flights near Liverpool John Lennon Airport\'s controlled airspace. We coordinate directly with air traffic control and handle all the complex airspace permissions so you don\'t have to.',
  },
  {
    question: 'How much does a drone survey cost in Liverpool?',
    answer: 'Liverpool drone survey costs vary based on site size, complexity, airspace requirements, and deliverables needed. As a guide, small site surveys start from around £500, while larger commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Liverpool project.',
  },
  {
    question: 'How quickly can you respond to Liverpool projects?',
    answer: 'We can typically mobilise for Liverpool projects within 24-48 hours for urgent requirements. Our experienced team is well-versed in obtaining rapid airspace permissions when needed. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place.',
  },
  {
    question: 'Do you cover all of Merseyside?',
    answer: 'Yes, we provide comprehensive drone survey services across all of Merseyside including Liverpool, Wirral, Sefton, Knowsley, St Helens, and the wider city region. We also cover Halton and Warrington. No location is too challenging for our experienced team.',
  },
  {
    question: 'What Liverpool projects have you completed?',
    answer: 'We\'ve completed numerous projects across Merseyside including port and maritime surveys, construction monitoring at major waterfront developments, infrastructure inspections, roof surveys for commercial properties, and topographic surveys for planning applications. Our experience covers everything from Liverpool Waters to heritage buildings.',
  },
  {
    question: 'How accurate are your Liverpool drone surveys?',
    answer: 'Our Liverpool drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'Can you survey port and maritime facilities?',
    answer: 'Yes, we have extensive experience surveying port facilities, docks, and maritime infrastructure across Merseyside. We work closely with port operators and understand the unique requirements of maritime environments, including coordination with shipping movements and port security.',
  },
  {
    question: 'What deliverables do you provide for Liverpool projects?',
...
export default function LiverpoolPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Liverpool's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Liverpool</>}
        description="Expert drone survey services across Merseyside. CAA-approved drone operators delivering precision aerial data for port, maritime, regeneration, and construction projects throughout the region."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Liverpool Drone Survey Experts
              </p>
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Professional Kit. <span className="text-wipe-red">Liverpool Expertise.</span> <span className="underline-sweep">Maritime Projects Handled.</span>
              </h2>
              <p className="text-text-secondary text-lg mb-6 leading-relaxed">
                Liverpool is a city of major regeneration and maritime heritage. From the
                world-famous waterfront to the thriving port, major construction projects
                to urban renewal schemes, you need drone operators who understand the region.
              </p>
              <p className="text-text-primary text-lg mb-8 leading-relaxed font-medium">
                ...
                <span className="text-teal"> maritime and port experience</span> and enterprise-grade equipment.
                Every Liverpool project we deliver is fully compliant and professional.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Liverpool Airspace Experts</p>
                    <p className="text-text-secondary text-sm">Airport coordination & permissions</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid Liverpool Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Liverpool"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Liverpool Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Liverpool</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  all of Merseyside. From waterfront regeneration projects to port facilities,
                ...
                <p>
                  ...
                  hundreds of projects across the region, from Liverpool Waters to Wirral,
                  the Baltic Triangle to Birkenhead docks.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-gold mb-1">6</p>
                  <p className="text-text-secondary text-sm">Boroughs Covered</p>
                </div>
                <div className="text-center">
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Liverpool Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Liverpool
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Liverpool projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Liverpool Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Liverpool project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Liverpool project?</p>
            <button
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Drone Surveys for Liverpool Sectors
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We deliver tailored drone survey solutions across Liverpool's key industries.
            </p>
          </div>
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            ...
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Liverpool drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Liverpool projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across Merseyside
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across all of Merseyside
              and the Liverpool City Region. No location is too challenging.
            </p>
          </div>
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Liverpool Waters', 'Baltic Triangle', 'Commercial District', 'Knowledge Quarter', 'Port of Liverpool', 'Wirral Waters', 'Speke', 'Knowsley Business Park'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Liverpool drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Liverpool drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Merseyside including airport coordination.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Liverpool project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Liverpool.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Liverpool Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Liverpool drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Liverpool airspace expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Liverpool */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Skykam Drone Inspections Liverpool',
            alternateName: 'Skykam LTD',
            description: 'Professional drone survey services in Liverpool and Merseyside. CAA-approved drone operators delivering precision aerial data for port, maritime, regeneration, and construction projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            areaServed: [
              ...
              { '@type': 'AdministrativeArea', name: 'Halton' },
            ],
            geo: {
              '@type': 'GeoCoordinates',
              latitude: 53.4084,
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Liverpool Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Liverpool',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Liverpool',
                  },
                },
                {
                  '@type': 'Offer',
