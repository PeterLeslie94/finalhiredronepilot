...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Leicester.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Leicester construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Leicestershire.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Leicester building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Leicester.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Leicester and Leicestershire.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Leicester project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all equipment. We handle all CAA regulations and site-specific risk assessments for your Leicester project.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Leicester using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Textiles & Fashion', Icon: Shirt, description: 'Textile manufacturing, fashion logistics, warehouse facilities' },
  { name: 'Manufacturing', Icon: Factory, description: 'Industrial facilities, food processing, engineering works' },
  { name: 'Space Technology', Icon: Rocket, description: 'Space Park Leicester, satellite facilities, research centres' },
  { name: 'Construction', Icon: HardHat, description: 'City centre regeneration, Waterside, major developments' },
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Leicester and Leicestershire.',
  },
  {
    name: 'Fully Insured',
...
const leicesterAreas = [
  {
    region: 'Leicester City Centre',
    boroughs: ['City Centre', 'Cultural Quarter', 'St Georges', 'Highfields', 'Clarendon Park'],
  },
  {
    region: 'North Leicester',
    boroughs: ['Belgrave', 'Rushey Mead', 'Beaumont Leys', 'Birstall', 'Thurmaston'],
  },
  {
    region: 'South Leicester',
    boroughs: ['Oadby', 'Wigston', 'Blaby', 'Narborough', 'Enderby'],
  },
  {
    region: 'East Leicester',
    boroughs: ['Evington', 'Thurnby', 'Scraptoft', 'Humberstone', 'Hamilton'],
  },
  {
    region: 'West Leicester',
    boroughs: ['Braunstone', 'Glenfield', 'Kirby Muxloe', 'Ratby', 'Groby'],
  },
];
...
const faqs = [
  {
    ...
    answer: 'Yes, we hold the necessary CAA permissions and can coordinate with East Midlands Airport for flights in controlled airspace. We handle all the complex airspace permissions and safety coordination so you don\'t have to. Our team has extensive experience operating in the Leicestershire area.',
  },
  {
    question: 'How much does a drone survey cost in Leicester?',
    answer: 'Leicester drone survey costs vary based on site size, complexity, and deliverables needed. As a guide, small site surveys start from around £500, while larger commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Leicester project.',
  },
  {
    question: 'Do you work with manufacturing facilities?',
    answer: 'Yes, we have extensive experience working with manufacturing and industrial facilities across Leicester, including textile manufacturing, food processing plants, and engineering works. Our team understands the specific protocols needed for these operational environments.',
  },
  {
    question: 'How quickly can you respond to Leicester projects?',
    answer: 'We can typically mobilise for Leicester projects within 24-48 hours for urgent requirements. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place and optimal flight conditions.',
  },
  {
    question: 'What Leicester projects have you completed?',
    answer: 'We\'ve completed numerous projects across Leicester and Leicestershire including construction monitoring at major developments, manufacturing facility surveys, Space Park Leicester site surveys, and topographic surveys for planning applications across the region.',
  },
  {
    question: 'How accurate are your Leicester drone surveys?',
    answer: 'Our Leicester drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'What areas of Leicestershire do you cover?',
    answer: 'We provide drone survey services across all of Leicester and the wider Leicestershire area, including Loughborough, Hinckley, Melton Mowbray, and Market Harborough. We also cover neighbouring counties including Nottinghamshire, Derbyshire, and Northamptonshire.',
  },
  {
    question: 'What deliverables do you provide for Leicester projects?',
...
export default function LeicesterPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Leicester's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Leicester</>}
        description="Expert drone survey services across Leicester and Leicestershire. CAA-approved drone operators delivering precision aerial data for textiles, manufacturing, space technology, and construction projects."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Leicester Drone Survey Experts
              </p>
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Professional Kit. <span className="text-wipe-red">East Midlands Expertise.</span> <span className="underline-sweep">Innovation Delivered.</span>
              </h2>
              <p className="text-text-secondary text-lg mb-6 leading-relaxed">
                Leicester is a hub for manufacturing, textiles, and cutting-edge space technology.
                From industrial facilities to Space Park Leicester, you need drone
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Industrial Expertise</p>
                    <p className="text-text-secondary text-sm">Manufacturing, textiles, space tech</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Leicester"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-teal font-bold text-lg">120+</p>
                      <p className="text-text-secondary text-sm">Leicester Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Leicester</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  Leicester and Leicestershire. From manufacturing facilities to space technology
                  centres, we have the expertise to deliver precision data.
                </p>
                <p>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-gold mb-1">7</p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Leicester Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Leicester
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Leicester projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Leicester Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Leicester project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Leicester project?</p>
            <button
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Ready to Discuss Your Leicester Project?
            </h3>
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Leicester drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Leicester projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across Leicestershire
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across Leicester
              and all districts of Leicestershire.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {leicesterAreas.map((area) => (
              <div
                key={area.region}
                className="bg-background-alt border border-border rounded-xl p-6 hover:border-gold hover:shadow-lg transition-all duration-300"
              >
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Space Park Leicester', 'Waterside', 'Pioneer Park', 'Abbey Meadows', 'St Georges', 'Cultural Quarter', 'Fosse Park', 'Grove Park'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Leicester drone operations.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Leicester drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  Fully approved for commercial drone operations across Leicester
                  and Leicestershire including near East Midlands Airport.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Leicester project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Leicester.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Leicester Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Leicester drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Manufacturing & space tech expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Leicester */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Skykam Drone Inspections Leicester',
            alternateName: 'Skykam LTD',
            description: 'Professional drone survey services in Leicester and Leicestershire. CAA-approved drone operators delivering precision aerial data for textiles, manufacturing, space technology, and construction projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Leicester Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Leicester',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Leicester',
                  },
                },
                {
                  '@type': 'Offer',
