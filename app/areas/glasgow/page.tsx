...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Glasgow.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Glasgow construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Glasgow and the Clyde Valley.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Glasgow building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Glasgow.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Glasgow and surrounding areas.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Glasgow project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains Glasgow airspace permissions, and prepares all necessary equipment. We handle all CAA regulations and site-specific risk assessments for your project.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-approved drone pilots capture high-quality aerial data across Glasgow using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Shipbuilding & Marine', Icon: Anchor, description: 'BAE Systems, Govan shipyards, Clyde waterfront' },
  { name: 'Technology', Icon: Cpu, description: 'STV, tech startups, innovation districts' },
  { name: 'Construction', Icon: HardHat, description: 'Buchanan Wharf, Barras regeneration, major developments' },
  { name: 'Manufacturing', Icon: Factory, description: 'Industrial estates, production facilities, warehousing' },
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations in Glasgow controlled airspace.',
  },
  {
    name: 'Fully Insured',
...
const glasgowAreas = [
  {
    region: 'City Centre',
    areas: ['Merchant City', 'Buchanan Street', 'George Square', 'Broomielaw', 'Anderston'],
  },
  {
    region: 'North Glasgow',
    areas: ['Maryhill', 'Springburn', 'Possilpark', 'Milton', 'Bishopbriggs'],
  },
  {
    region: 'South Glasgow',
    areas: ['Govan', 'Pollokshields', 'Shawlands', 'Cathcart', 'Castlemilk'],
  },
  {
    region: 'East Glasgow',
    areas: ['Dennistoun', 'Parkhead', 'Bridgeton', 'Tollcross', 'Easterhouse'],
  },
  {
    region: 'West Glasgow',
    areas: ['Partick', 'Finnieston', 'Scotstoun', 'Clydebank', 'Dumbarton'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones in Glasgow city centre?',
    answer: 'Yes, we hold the necessary CAA permissions and can obtain clearances for flights in Glasgow\'s airspace, including near Glasgow Airport. We handle all the complex airspace permissions and coordinate with air traffic control when required.',
  },
  {
    question: 'How much does a drone survey cost in Glasgow?',
    answer: 'Glasgow drone survey costs vary based on site size, complexity, airspace requirements, and deliverables needed. As a guide, small site surveys start from around £500, while larger commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Glasgow project.',
  },
  {
    question: 'How quickly can you respond to Glasgow projects?',
    answer: 'Being based in nearby Dundee (approximately 80 miles away), we can typically mobilise for Glasgow projects within 24-48 hours. Our Scottish headquarters means fast response times and local expertise for all Glasgow projects.',
  },
  {
    question: 'Do you have experience with industrial sites in Glasgow?',
    answer: 'Yes, our team has extensive experience surveying industrial facilities, shipyards, and manufacturing sites across Glasgow. We understand the health and safety requirements and work closely with site managers to ensure safe operations.',
  },
  {
    question: 'What Glasgow projects have you completed?',
    answer: 'We\'ve completed numerous projects across Glasgow including construction monitoring at Buchanan Wharf, shipyard surveys for BAE Systems, roof inspections for commercial properties, and topographic surveys for planning applications throughout the Greater Glasgow area.',
  },
  {
    question: 'How accurate are your Glasgow drone surveys?',
    answer: 'Our Glasgow drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'What areas of Glasgow do you cover?',
    answer: 'We provide drone survey services across all of Greater Glasgow, including the city centre, Govan, Partick, and surrounding areas. We also cover East Dunbartonshire, West Dunbartonshire, South Lanarkshire, and North Lanarkshire.',
  },
  {
    question: 'What deliverables do you provide for Glasgow projects?',
...
export default function GlasgowPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Scotland's Largest City Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Glasgow</>}
        description="Expert drone survey services across Glasgow and the Clyde Valley. CAA-approved drone operators delivering precision aerial data for construction, shipbuilding, and tech industry projects. Based in nearby Dundee for rapid response."
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Industrial Specialists</p>
                    <p className="text-text-secondary text-sm">Shipyards, factories, manufacturing sites</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-text-secondary text-sm">80 miles from our HQ - next day available</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Glasgow"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Glasgow Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Glasgow</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  all of Glasgow and the Clyde Valley. From Govan shipyards to the bustling
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-gold mb-1">80mi</p>
                  <p className="text-text-secondary text-sm">From Dundee HQ</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold text-gold mb-1">48hr</p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Glasgow Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Glasgow
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Glasgow projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Glasgow Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Glasgow project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Glasgow project?</p>
            <button
        ...
        <div className="container">
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            ...
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Glasgow drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Glasgow projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across Glasgow
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across all of Greater Glasgow
              and the Clyde Valley. No location is too challenging.
            </p>
          </div>
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Buchanan Wharf', 'IFSD', 'Pacific Quay', 'Broomielaw', 'Merchant City', 'Finnieston', 'Govan', 'Clydebank'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Glasgow drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Glasgow drone operations.
                </p>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Glasgow project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Glasgow.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Glasgow Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Glasgow drone survey requirements? Complete the form
      ...
      {/* Schema Markup for Local Business - Glasgow */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Skykam Drone Inspections Glasgow',
            alternateName: 'Skykam LTD',
            description: 'Professional drone survey services in Glasgow and the Clyde Valley. CAA-approved drone operators delivering precision aerial data for construction, shipbuilding, and technology projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Glasgow Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Glasgow',
                  },
                },
                {
                  '@type': 'Offer',
                ...
                },
                {
                  ...
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Industrial Survey Glasgow',
                  },
                },
                {
                  '@type': 'Offer',
