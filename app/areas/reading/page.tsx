...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Reading.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Reading construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Berkshire.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Reading building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Reading.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Reading and surrounding areas.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Reading project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all equipment. We handle all CAA regulations and site-specific risk assessments for Reading locations.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Reading using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Technology', Icon: Cpu, description: 'Microsoft, Oracle, Cisco headquarters, tech parks' },
  { name: 'Corporate HQs', Icon: Briefcase, description: 'Thames Valley business centres, corporate campuses' },
  { name: 'Commercial Property', Icon: Building2, description: 'Office parks, retail developments, business estates' },
  { name: 'Energy & Utilities', Icon: Zap, description: 'SSE, Thames Water, utility infrastructure' },
  { name: 'Property Development', Icon: HomeIcon, description: 'New developments, residential projects, regeneration' },
  { name: 'Heritage & Conservation', Icon: Landmark, description: 'Reading Abbey, historic buildings, conservation areas' },
];
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Berkshire.',
  },
  {
    name: 'Fully Insured',
...
const readingAreas = [
  {
    region: 'Reading Town',
    boroughs: ['Town Centre', 'Caversham', 'Tilehurst', 'Earley', 'Whitley'],
  },
  {
    region: 'West Berkshire',
    boroughs: ['Newbury', 'Thatcham', 'Hungerford', 'Pangbourne', 'Theale'],
  },
  {
    region: 'Wokingham',
    boroughs: ['Wokingham', 'Woodley', 'Winnersh', 'Twyford', 'Crowthorne'],
  },
  {
    region: 'Bracknell Forest',
    boroughs: ['Bracknell', 'Sandhurst', 'Binfield', 'Warfield', 'Ascot'],
  },
  {
    region: 'South Oxfordshire',
    boroughs: ['Henley-on-Thames', 'Sonning', 'Goring', 'Wallingford'],
  },
];

const faqs = [
  {
    question: 'Can you fly drones near Heathrow Airport from Reading?',
    answer: 'Yes, we hold the necessary CAA permissions and can obtain NATS clearances for flights in areas affected by Heathrow\'s airspace. The eastern parts of Reading and Thames Valley are within controlled airspace, and we have extensive experience coordinating flights in these areas. We handle all the complex airspace permissions so you don\'t have to.',
  },
  {
    question: 'How much does a drone survey cost in Reading?',
    answer: 'Reading drone survey costs vary based on site size, complexity, and deliverables needed. As a guide, small site surveys start from around £500, while larger corporate campus or commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Thames Valley project.',
  },
  {
    question: 'Do you work with corporate headquarters in Thames Valley?',
    answer: 'Yes, we have extensive experience working with major corporate clients across the Thames Valley, including tech companies and multinational headquarters. We understand security protocols and can work within restricted access environments while maintaining confidentiality.',
  },
  {
    question: 'Can you survey tech parks and business estates?',
    answer: 'Absolutely. We regularly survey business parks including Green Park, Thames Valley Park, and Arlington Business Park. Our enterprise-grade equipment captures detailed aerial data for asset management, roof inspections, and site planning.',
  },
  {
    question: 'How quickly can you respond to Reading projects?',
    answer: 'We can typically mobilise for Reading projects within 24-48 hours for urgent requirements. Our proximity to the Thames Valley allows rapid response. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place.',
  },
  {
    question: 'What deliverables do you provide for Reading projects?',
  ...
  {
    question: 'Do you cover the wider Thames Valley area?',
    answer: 'Yes, we provide comprehensive coverage across the entire Thames Valley corridor, from Slough and Windsor to Newbury and Oxford. This includes all of Berkshire, parts of Buckinghamshire, and South Oxfordshire.',
  },
  {
    question: 'How accurate are your Reading drone surveys?',
    answer: 'Our Reading drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
];
...
export default function ReadingPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Reading's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Reading</>}
        description="Expert drone survey services across Reading and the Thames Valley. CAA-approved drone operators delivering precision aerial data for tech companies, corporate headquarters, and construction projects."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Reading Drone Survey Experts
              </p>
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Professional Kit. <span className="text-wipe-red">Thames Valley Expertise.</span> <span className="underline-sweep">Corporate-Ready Service.</span>
              </h2>
              <p className="text-text-secondary text-lg mb-6 leading-relaxed">
                Reading and the Thames Valley is home to major tech companies and corporate
                headquarters. You need drone survey operators who understand enterprise
                requirements and can deliver to corporate standards.
              </p>
              <p className="text-text-primary text-lg mb-8 leading-relaxed font-medium">
                ...
                <span className="text-teal"> corporate project experience</span> and enterprise-grade equipment.
                Every Reading project we deliver meets the highest professional standards.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Corporate Experience</p>
                    <p className="text-text-secondary text-sm">Major HQs & tech campus expertise</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Rapid Reading Response</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Reading"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Thames Valley Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Reading</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  Reading and the wider Thames Valley. From corporate headquarters to
                  construction sites, we have the expertise to handle any project.
                </p>
                <p>
                  Our team of CAA-certified drone pilots and qualified surveyors have completed
                  numerous projects across the region, from tech parks to residential
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Reading Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Reading
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Thames Valley projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Reading Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Reading project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Reading project?</p>
            <button
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Drone Surveys for Thames Valley Sectors
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We deliver tailored drone survey solutions across the Thames Valley's key industries.
            </p>
          </div>
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            ...
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Reading drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Reading projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across the Thames Valley
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across Reading
              and the wider Thames Valley corridor. No location is too challenging.
            </p>
          </div>
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            <h4 className="text-white font-bold text-xl mb-4">Key Business Parks & Corporate Campuses</h4>
            <div className="flex flex-wrap justify-center gap-4">
              {['Green Park', 'Thames Valley Park', 'Arlington Business Park', 'Winnersh Triangle', 'Matrix Park', 'Reading International', 'The Blade', 'Forbury Square'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Reading drone operations.
            </p>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Reading drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  the Thames Valley with all necessary permissions.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Reading project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Reading.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Reading Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Reading drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Thames Valley corporate expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Reading */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Skykam Drone Inspections Reading',
            alternateName: 'Skykam LTD',
            description: 'Professional drone survey services in Reading and the Thames Valley. CAA-approved drone operators delivering precision aerial data for tech companies, corporate headquarters, and construction projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            url: 'https://skykam.co.uk/areas/reading',
            areaServed: [
              ...
              { '@type': 'AdministrativeArea', name: 'Bracknell Forest' },
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Reading Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Reading',
                  },
                },
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Aerial Survey Thames Valley',
                  },
                },
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Topographic Survey Reading',
                  },
                },
                {
                  '@type': 'Offer',
