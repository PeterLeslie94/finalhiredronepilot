...
const services = [
  {
    title: 'Drone Survey',
    description: 'Comprehensive aerial surveys delivering precise topographic data and 3D models across Derby.',
    image: '/images/services/service-drone-survey.avif',
    href: '/services/drone-survey',
  },
  {
    title: 'Volumetric Survey',
    description: 'Accurate stockpile measurements and volumetric calculations for Derby construction sites.',
    image: '/images/services/service-volumetric-survey.avif',
    href: '/services/volumetric-survey',
  },
  {
    title: 'LiDAR Mapping',
    description: 'Precision LiDAR scanning for detailed terrain models across Derbyshire.',
    image: '/images/services/service-lidar-mapping.avif',
    href: '/services/lidar-mapping',
  },
  {
    title: 'Thermal Imaging',
    description: 'Thermal drone inspections for Derby building diagnostics and energy audits.',
    image: '/images/services/service-thermal-imaging.avif',
    href: '/services/thermal-imaging',
  },
  {
    title: 'Topographic Survey',
    description: 'Detailed topographic surveys for planning, design and construction projects in Derby.',
    image: '/images/services/service-topographic-survey.avif',
    href: '/services/topographic-survey',
  },
  {
    title: 'Building Inspection',
    description: 'Safe, efficient building and roof inspections across Derby and Derbyshire.',
...
const processSteps = [
  {
    ...
    title: 'Consultation',
    description: 'We discuss your Derby project requirements and objectives to determine the best survey approach. Our experts will recommend the optimal drone technology and data outputs for your specific needs.',
  ...
  },
  {
    ...
    title: 'Planning',
    description: 'Our team plans the flight path, obtains necessary airspace permissions, and prepares all equipment. We handle all CAA regulations and site-specific risk assessments for your Derby project.',
  ...
  },
  {
    ...
    category: 'On Site',
    title: 'Data Capture',
    description: 'Our CAA-authorised independent drone pilots capture high-quality aerial data across Derby using professional drone equipment. Survey-grade accuracy is achieved through RTK GPS and ground control points.',
...
const industries = [
  { name: 'Rail & Transport', Icon: Train, description: 'Alstom, rail manufacturing, station developments, infrastructure' },
  { name: 'Aerospace', Icon: Plane, description: 'Rolls-Royce, aerospace manufacturing, precision engineering' },
  { name: 'Manufacturing', Icon: Factory, description: 'Toyota, industrial facilities, advanced manufacturing' },
  { name: 'Construction', Icon: HardHat, description: 'City centre regeneration, Becketwell, major developments' },
...
const accreditations = [
  {
    ...
    description: 'Approved for commercial drone operations across Derby and Derbyshire.',
  },
  {
    name: 'Fully Insured',
...
const derbyAreas = [
  {
    region: 'Derby City Centre',
    boroughs: ['City Centre', 'Cathedral Quarter', 'Castleward', 'Darley Abbey', 'Little Chester'],
  },
  {
    region: 'North Derbyshire',
    boroughs: ['Allestree', 'Breadsall', 'Quarndon', 'Duffield', 'Belper'],
  },
  {
    region: 'South Derbyshire',
    boroughs: ['Littleover', 'Mickleover', 'Findern', 'Willington', 'Melbourne'],
  },
  {
    region: 'East Derbyshire',
    boroughs: ['Spondon', 'Chaddesden', 'Oakwood', 'Borrowash', 'Draycott'],
  },
  {
    region: 'West Derbyshire',
    boroughs: ['Mackworth', 'Markeaton', 'Kedleston', 'Ashbourne', 'Matlock'],
  },
];
...
const faqs = [
  {
    ...
    answer: 'Yes, we hold the necessary CAA permissions and can coordinate with East Midlands Airport for flights in controlled airspace. We handle all the complex airspace permissions and safety coordination so you don\'t have to. Our team has extensive experience operating in the Derby and Derbyshire area.',
  },
  {
    question: 'How much does a drone survey cost in Derby?',
    answer: 'Derby drone survey costs vary based on site size, complexity, and deliverables needed. As a guide, small site surveys start from around £500, while larger commercial projects are priced per hectare. Contact us for a free, no-obligation quote tailored to your specific Derby project.',
  },
  {
    question: 'Do you work with aerospace and rail facilities?',
    answer: 'Yes, we have extensive experience working with aerospace and rail facilities across Derby, including sites associated with Rolls-Royce and Alstom. Our team understands the specific security protocols and compliance requirements needed for these high-value, sensitive environments.',
  },
  {
    question: 'How quickly can you respond to Derby projects?',
    answer: 'We can typically mobilise for Derby projects within 24-48 hours for urgent requirements. For planned projects, we recommend 1-2 weeks notice to ensure all permissions are in place and optimal flight conditions.',
  },
  {
    question: 'What Derby projects have you completed?',
    answer: 'We\'ve completed numerous projects across Derby and Derbyshire including construction monitoring at major developments, rail infrastructure surveys, aerospace facility mapping, and topographic surveys for planning applications across the region.',
  },
  {
    question: 'How accurate are your Derby drone surveys?',
    answer: 'Our Derby drone surveys achieve accuracies of ±2-5cm when using ground control points (GCPs). For projects requiring higher precision, we can achieve sub-centimeter accuracy using RTK-enabled drones and post-processing techniques. All surveys meet RICS and industry standards.',
  },
  {
    question: 'What areas of Derbyshire do you cover?',
    answer: 'We provide drone survey services across all of Derby and the wider Derbyshire area, including Chesterfield, Buxton, Matlock, and the Peak District. We also cover neighbouring counties including Nottinghamshire, Leicestershire, and Staffordshire.',
  },
  {
    question: 'What deliverables do you provide for Derby projects?',
...
export default function DerbyPage() {
  return (
    <>
      {/* Hero Section */}
      <Hero
        subtitle="Derby's Trusted Drone Survey Specialists"
        title={<>Professional <span className="text-gold">Drone Survey</span> Derby</>}
        description="Expert drone survey services across Derby and Derbyshire. CAA-approved drone operators delivering precision aerial data for rail, aerospace, Rolls-Royce, and construction projects."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <p className="text-gold font-semibold uppercase tracking-wider mb-3 text-sm">
                Derby Drone Survey Experts
              </p>
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Professional Kit. <span className="text-wipe-red">East Midlands Expertise.</span> <span className="underline-sweep">Engineering Excellence.</span>
              </h2>
              <p className="text-text-secondary text-lg mb-6 leading-relaxed">
                Derby is a global centre for rail and aerospace engineering.
                From Rolls-Royce to Alstom, you need drone survey operators
                who understand high-security, precision engineering environments.
              </p>
              <p className="text-text-primary text-lg mb-8 leading-relaxed font-medium">
                ...
                <span className="text-teal"> aerospace & rail sector experience</span> and enterprise-grade equipment.
                Every Derby project we deliver is fully compliant and professional.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal">Aerospace & Rail Expertise</p>
                    <p className="text-text-secondary text-sm">Rolls-Royce, Alstom specialists</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal/10 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-gold/30">
                  <img
                    ...
                    alt="Skykam Drone Inspections drone pilot operating professional survey drone in Derby"
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-sm">Derby Projects</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-teal mb-6 leading-tight">
                Drone Survey <span className="text-wipe-red">Derby</span> Specialists
              </h2>
              <div className="space-y-4 text-text-secondary text-lg mb-8">
                <p>
                  ...
                  Derby and Derbyshire. From aerospace manufacturing to rail infrastructure,
                  we have the expertise to deliver precision data.
                </p>
                <p>
                  ...
                  industrial estates throughout the East Midlands.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-gold mb-1">9</p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-gold font-semibold uppercase tracking-wider mb-3">
              Derby Drone Services
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Our Skykam Drone Inspections in Derby
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive aerial survey solutions for Derby projects,
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Derby Drone Survey Process
            </h3>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              From initial consultation to final delivery, our streamlined process
              ensures efficient and accurate results for your Derby project.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-white/60 mb-4">Ready to start your Derby project?</p>
            <button
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Drone Surveys for Derby Sectors
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We deliver tailored drone survey solutions across Derby's key industries.
            </p>
          </div>
          ...
          <div className="mt-12 text-center bg-teal rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Ready to Discuss Your Derby Project?
            </h3>
            <p className="text-white/70 mb-6 max-w-xl mx-auto">
              Get a free, no-obligation quote for your Derby drone survey.
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              See how drone survey technology compares to conventional survey methods for Derby projects.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
              Skykam Drone Inspections Across Derbyshire
            </h3>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We provide professional drone survey services across Derby
              and all districts of Derbyshire.
            </p>
          </div>
          ...
          <div className="bg-teal rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Rolls-Royce', 'Alstom Litchurch Lane', 'Pride Park', 'Becketwell', 'Castleward', 'Infinity Park', 'Wyvern Business Park', 'Cathedral Quarter'].map((district) => (
                <span
                  key={district}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              ...
              for all Derby drone operations.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  peace of mind for all Derby drone operations.
                </p>
            ...
            <div className="group relative md:-mt-4">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  Fully approved for commercial drone operations across Derby
                  and Derbyshire including near East Midlands Airport.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-teal-dark rounded-2xl p-8 h-full border-2 border-gold/30 group-hover:border-gold transition-all duration-300">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  Derby project investments and deliverables.
                </p>
                <div className="mt-6 pt-4 border-t border-gold/20">
                  <div className="flex items-center gap-2 text-white/60 text-xs">
                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="section bg-teal-dark">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Find answers to common questions about our drone survey services in Derby.
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-teal mb-4">
                Request a Free Derby Drone Survey Quote
              </h3>
              <p className="text-text-secondary text-lg mb-6">
                Ready to discuss your Derby drone survey requirements? Complete the form
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-text-primary">Aerospace & rail expertise</span>
                </div>
              </div>
            </div>
            <div>
      ...
      {/* Schema Markup for Local Business - Derby */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            name: 'Skykam Drone Inspections Derby',
            alternateName: 'Skykam LTD',
            description: 'Professional drone survey services in Derby and Derbyshire. CAA-approved drone operators delivering precision aerial data for rail, aerospace, Rolls-Royce, and construction projects.',
            address: {
              '@type': 'PostalAddress',
            ...
            hasOfferCatalog: {
              '@type': 'OfferCatalog',
              name: 'Derby Skykam Drone Inspections',
              itemListElement: [
                {
                  '@type': 'Offer',
                  itemOffered: {
                    '@type': 'Service',
                    name: 'Drone Survey Derby',
                  },
                },
                {
                  '@type': 'Offer',
