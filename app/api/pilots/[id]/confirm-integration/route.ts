...
function retiredPage(): Response {
  const title = 'Integration Confirmation Retired';
  const message =
    'This confirmation step is no longer used. Approved HireDronePilot listings now go live immediately without a separate integration action.';
